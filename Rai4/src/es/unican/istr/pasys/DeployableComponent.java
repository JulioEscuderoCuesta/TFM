 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.pasys.DeployableComponent#getDeploymentConfig <em>Deployment Config</em>}</li>
 * </ul>
 *
 * @see es.unican.istr.pasys.PasysPackage#getDeployableComponent()
 * @model abstract="true"
 * @generated
 */
public interface DeployableComponent extends EObject {
	 ...
	 * @see es.unican.istr.pasys.PasysPackage#getDeployableComponent_DeploymentConfig()
	...
	/**
	 * Sets the value of the '{@link es.unican.istr.pasys.DeployableComponent#getDeploymentConfig <em>Deployment Config</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
