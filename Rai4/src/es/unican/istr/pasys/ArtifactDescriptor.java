 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.pasys.ArtifactDescriptor#getLocalPath <em>Local Path</em>}</li>
 * </ul>
 *
 * @see es.unican.istr.pasys.PasysPackage#getArtifactDescriptor()
 * @model
 * @generated
 */
public interface ArtifactDescriptor extends FileDescriptor {
	 ...
	 * @see es.unican.istr.pasys.PasysPackage#getArtifactDescriptor_LocalPath()
	 * @model required="true"
	 * @generated
	 */
	String getLocalPath();
	...
	/**
	 * Sets the value of the '{@link es.unican.istr.pasys.ArtifactDescriptor#getLocalPath <em>Local Path</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
