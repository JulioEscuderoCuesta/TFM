 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.pasys.DataCenter#getRacks <em>Racks</em>}</li>
 * </ul>
 *
 * @see es.unican.istr.pasys.PasysPackage#getDataCenter()
 * @model
 * @generated
 */
public interface DataCenter extends NamedElement {
	 ...
	 * The list contents are of type {@link es.unican.istr.pasys.Rack}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Racks</em>' containment reference list.
	 * @see es.unican.istr.pasys.PasysPackage#getDataCenter_Racks()
