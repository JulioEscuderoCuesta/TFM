 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.pasys.PlatformService#getHost <em>Host</em>}</li>
 * </ul>
 *
 * @see es.unican.istr.pasys.PasysPackage#getPlatformService()
 * @model abstract="true"
 * @generated
 */
public interface PlatformService extends PlatformResource, DeployableComponent {
	 ...
	 * @see es.unican.istr.pasys.PasysPackage#getPlatformService_Host()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link es.unican.istr.pasys.PlatformService#getHost <em>Host</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
