 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.pasys.Rack#getNodes <em>Nodes</em>}</li>
 * </ul>
 *
 * @see es.unican.istr.pasys.PasysPackage#getRack()
 * @model
 * @generated
 */
public interface Rack extends NamedElement {
	 ...
	 * @see es.unican.istr.pasys.PasysPackage#getRack_Nodes()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link es.unican.istr.pasys.Rack#getNodes <em>Nodes</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
