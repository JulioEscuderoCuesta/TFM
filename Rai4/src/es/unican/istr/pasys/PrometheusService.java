 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.pasys.PrometheusService#getExportersData <em>Exporters Data</em>}</li>
 * </ul>
 *
 * @see es.unican.istr.pasys.PasysPackage#getPrometheusService()
 * @model
 * @generated
 */
public interface PrometheusService extends MonitoringService {
	 ...
	 * The list contents are of type {@link es.unican.istr.pasys.ExporterData}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Exporters Data</em>' containment reference list.
	 * @see es.unican.istr.pasys.PasysPackage#getPrometheusService_ExportersData()
