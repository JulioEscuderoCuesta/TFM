 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.pasys.WorkloadStreamData#getHolder <em>Holder</em>}</li>
 * </ul>
 *
 * @see es.unican.istr.pasys.PasysPackage#getWorkloadStreamData()
 * @model
 * @generated
 */
public interface WorkloadStreamData extends SystemElement, StreamData {
	 ...
	 * @see es.unican.istr.pasys.PasysPackage#getWorkloadStreamData_Holder()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link es.unican.istr.pasys.WorkloadStreamData#getHolder <em>Holder</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
