 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.pasys.CassandraService#getNumTokens <em>Num Tokens</em>}</li>
 *   <li>{@link es.unican.istr.pasys.CassandraService#getSeeds <em>Seeds</em>}</li>
 *   <li>{@link es.unican.istr.pasys.CassandraService#getSeedProviderClass <em>Seed Provider Class</em>}</li>
 *   <li>{@link es.unican.istr.pasys.CassandraService#getEndpointSnitch <em>Endpoint Snitch</em>}</li>
 *   <li>{@link es.unican.istr.pasys.CassandraService#getDataFileDir <em>Data File Dir</em>}</li>
 *   <li>{@link es.unican.istr.pasys.CassandraService#getStoragePort <em>Storage Port</em>}</li>
 *   <li>{@link es.unican.istr.pasys.CassandraService#isAutoBootstrap <em>Auto Bootstrap</em>}</li>
 *   <li>{@link es.unican.istr.pasys.CassandraService#getCqlSchemas <em>Cql Schemas</em>}</li>
 *   <li>{@link es.unican.istr.pasys.CassandraService#getDataCenters <em>Data Centers</em>}</li>
 *   <li>{@link es.unican.istr.pasys.CassandraService#getSslStoragePort <em>Ssl Storage Port</em>}</li>
 *   <li>{@link es.unican.istr.pasys.CassandraService#getRpcPort <em>Rpc Port</em>}</li>
 * </ul>
 *
 * @see es.unican.istr.pasys.PasysPackage#getCassandraService()
 * @model
 * @generated
 */
public interface CassandraService extends PersistenceService {
	 ...
	 * @see es.unican.istr.pasys.PasysPackage#getCassandraService_NumTokens()
	...
	/**
	 * Sets the value of the '{@link es.unican.istr.pasys.CassandraService#getNumTokens <em>Num Tokens</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see es.unican.istr.pasys.PasysPackage#getCassandraService_Seeds()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link es.unican.istr.pasys.CassandraService#getSeeds <em>Seeds</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see es.unican.istr.pasys.PasysPackage#getCassandraService_SeedProviderClass()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link es.unican.istr.pasys.CassandraService#getSeedProviderClass <em>Seed Provider Class</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see es.unican.istr.pasys.PasysPackage#getCassandraService_EndpointSnitch()
	...
	/**
	 * Sets the value of the '{@link es.unican.istr.pasys.CassandraService#getEndpointSnitch <em>Endpoint Snitch</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see es.unican.istr.pasys.PasysPackage#getCassandraService_DataFileDir()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link es.unican.istr.pasys.CassandraService#getDataFileDir <em>Data File Dir</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see es.unican.istr.pasys.PasysPackage#getCassandraService_StoragePort()
	...
	/**
	 * Sets the value of the '{@link es.unican.istr.pasys.CassandraService#getStoragePort <em>Storage Port</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see es.unican.istr.pasys.PasysPackage#getCassandraService_AutoBootstrap()
	...
	/**
	 * Sets the value of the '{@link es.unican.istr.pasys.CassandraService#isAutoBootstrap <em>Auto Bootstrap</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link es.unican.istr.pasys.FileDescriptor}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Cql Schemas</em>' containment reference list.
	 * @see es.unican.istr.pasys.PasysPackage#getCassandraService_CqlSchemas()
	 ...
	 * The list contents are of type {@link es.unican.istr.pasys.DataCenter}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Data Centers</em>' containment reference list.
	 * @see es.unican.istr.pasys.PasysPackage#getCassandraService_DataCenters()
	 ...
	 * @see es.unican.istr.pasys.PasysPackage#getCassandraService_SslStoragePort()
	...
	/**
	 * Sets the value of the '{@link es.unican.istr.pasys.CassandraService#getSslStoragePort <em>Ssl Storage Port</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setRpcPort(int)
	 * @see es.unican.istr.pasys.PasysPackage#getCassandraService_RpcPort()
	...
	/**
	 * Sets the value of the '{@link es.unican.istr.pasys.CassandraService#getRpcPort <em>Rpc Port</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
