 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.pasys.impl.CassandraServiceImpl#getNumTokens <em>Num Tokens</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.CassandraServiceImpl#getSeeds <em>Seeds</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.CassandraServiceImpl#getSeedProviderClass <em>Seed Provider Class</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.CassandraServiceImpl#getEndpointSnitch <em>Endpoint Snitch</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.CassandraServiceImpl#getDataFileDir <em>Data File Dir</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.CassandraServiceImpl#getStoragePort <em>Storage Port</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.CassandraServiceImpl#isAutoBootstrap <em>Auto Bootstrap</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.CassandraServiceImpl#getCqlSchemas <em>Cql Schemas</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.CassandraServiceImpl#getDataCenters <em>Data Centers</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.CassandraServiceImpl#getSslStoragePort <em>Ssl Storage Port</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.CassandraServiceImpl#getRpcPort <em>Rpc Port</em>}</li>
 * </ul>
 *
 * @generated
 */
