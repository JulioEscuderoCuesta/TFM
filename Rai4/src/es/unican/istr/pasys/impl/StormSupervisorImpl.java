 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.pasys.impl.StormSupervisorImpl#getName <em>Name</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.StormSupervisorImpl#getId <em>Id</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.StormSupervisorImpl#getSupervisorSlotPorts <em>Supervisor Slot Ports</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.StormSupervisorImpl#getOwner <em>Owner</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.StormSupervisorImpl#getHost <em>Host</em>}</li>
 * </ul>
 *
 * @generated
 */
