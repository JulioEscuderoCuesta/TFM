 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.pasys.impl.WorkflowImpl#getDeploymentConfig <em>Deployment Config</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.WorkflowImpl#getOwnedStreamData <em>Owned Stream Data</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.WorkflowImpl#getOwnedTasks <em>Owned Tasks</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.WorkflowImpl#getRootTask <em>Root Task</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.WorkflowImpl#getOwnedTaskExecutors <em>Owned Task Executors</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.WorkflowImpl#getScheduler <em>Scheduler</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.WorkflowImpl#getOwnedMeters <em>Owned Meters</em>}</li>
 * </ul>
 *
 * @generated
 */
