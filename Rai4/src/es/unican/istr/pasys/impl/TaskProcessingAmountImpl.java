 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.pasys.impl.TaskProcessingAmountImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.TaskProcessingAmountImpl#getMeter <em>Meter</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.TaskProcessingAmountImpl#getHistogramBuckectNum <em>Histogram Buckect Num</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.TaskProcessingAmountImpl#getExpectedMaxTPA <em>Expected Max TPA</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.TaskProcessingAmountImpl#getExpectedMinTPA <em>Expected Min TPA</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.TaskProcessingAmountImpl#isLinearBucketDistribution <em>Linear Bucket Distribution</em>}</li>
 * </ul>
 *
 * @generated
 */
