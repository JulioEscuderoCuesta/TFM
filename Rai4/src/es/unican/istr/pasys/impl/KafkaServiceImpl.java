 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.pasys.impl.KafkaServiceImpl#getCommId <em>Comm Id</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.KafkaServiceImpl#getClientPort <em>Client Port</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.KafkaServiceImpl#getZookeeperConnect <em>Zookeeper Connect</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.KafkaServiceImpl#getZookeeperConnectionTimeout <em>Zookeeper Connection Timeout</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.KafkaServiceImpl#getListeners <em>Listeners</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.KafkaServiceImpl#getAdvertisedListeners <em>Advertised Listeners</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.KafkaServiceImpl#isAutoCreateTopicEnable <em>Auto Create Topic Enable</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.KafkaServiceImpl#isDeleteTopicEnable <em>Delete Topic Enable</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.KafkaServiceImpl#getNumPartitions <em>Num Partitions</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.KafkaServiceImpl#getNumRecoveryThreadsPerDataDir <em>Num Recovery Threads Per Data Dir</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.KafkaServiceImpl#getLogFlushIntervalMessages <em>Log Flush Interval Messages</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.KafkaServiceImpl#getLogFlushInterval <em>Log Flush Interval</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.KafkaServiceImpl#getNumNetworkThreads <em>Num Network Threads</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.KafkaServiceImpl#getNumIOThreads <em>Num IO Threads</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.KafkaServiceImpl#getSocketSendBufferBytes <em>Socket Send Buffer Bytes</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.KafkaServiceImpl#getSocketReceiveBufferBytes <em>Socket Receive Buffer Bytes</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.KafkaServiceImpl#getSocketRequestMaxBytes <em>Socket Request Max Bytes</em>}</li>
 * </ul>
 *
 * @generated
 */
