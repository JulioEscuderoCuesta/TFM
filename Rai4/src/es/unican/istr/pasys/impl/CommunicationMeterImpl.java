 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.pasys.impl.CommunicationMeterImpl#getMetric <em>Metric</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CommunicationMeterImpl extends NodeHostedMeterImpl implements CommunicationMeter {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetMetric(NetworkUtilization newMetric, NotificationChain msgs) {
		NetworkUtilization oldMetric = metric;
		metric = newMetric;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PasysPackage.COMMUNICATION_METER__METRIC, oldMetric, newMetric);
	...
	public void setMetric(NetworkUtilization newMetric) {
		if (newMetric != metric) {
			...
			if (metric != null)
				msgs = ((InternalEObject)metric).eInverseRemove(this, PasysPackage.NETWORK_UTILIZATION__METER, NetworkUtilization.class, msgs);
			if (newMetric != null)
				msgs = ((InternalEObject)newMetric).eInverseAdd(this, PasysPackage.NETWORK_UTILIZATION__METER, NetworkUtilization.class, msgs);
			msgs = basicSetMetric(newMetric, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PasysPackage.COMMUNICATION_METER__METRIC, newMetric, newMetric));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PasysPackage.COMMUNICATION_METER__METRIC:
				if (metric != null)
					msgs = ((InternalEObject)metric).eInverseRemove(this, PasysPackage.NETWORK_UTILIZATION__METER, NetworkUtilization.class, msgs);
				return basicSetMetric((NetworkUtilization)otherEnd, msgs);
		}
