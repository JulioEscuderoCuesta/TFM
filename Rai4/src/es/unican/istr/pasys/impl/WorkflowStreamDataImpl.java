 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.pasys.impl.WorkflowStreamDataImpl#getDeploymentConfig <em>Deployment Config</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.WorkflowStreamDataImpl#getRetention_ms <em>Retention ms</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.WorkflowStreamDataImpl#getRetention_bytes <em>Retention bytes</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.WorkflowStreamDataImpl#isCleanupPolicy <em>Cleanup Policy</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.WorkflowStreamDataImpl#getNumPartitions <em>Num Partitions</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.WorkflowStreamDataImpl#getNumReplication <em>Num Replication</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.WorkflowStreamDataImpl#getOwnedMeters <em>Owned Meters</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.WorkflowStreamDataImpl#getAssignedPartition <em>Assigned Partition</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.WorkflowStreamDataImpl#getMessageSize <em>Message Size</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.WorkflowStreamDataImpl#getSchemaFile <em>Schema File</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.WorkflowStreamDataImpl#isIsSingleUse <em>Is Single Use</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.WorkflowStreamDataImpl#getOwner <em>Owner</em>}</li>
 * </ul>
 *
 * @generated
 */
