 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.pasys.impl.ProcessingNodeImpl#getIp <em>Ip</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.ProcessingNodeImpl#getOs <em>Os</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.ProcessingNodeImpl#getConcurrencyLevel <em>Concurrency Level</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.ProcessingNodeImpl#getMemorySize <em>Memory Size</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.ProcessingNodeImpl#getSpeedFactor <em>Speed Factor</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.ProcessingNodeImpl#getConfigData <em>Config Data</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.ProcessingNodeImpl#getUserName <em>User Name</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.ProcessingNodeImpl#getConnectedTo <em>Connected To</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.ProcessingNodeImpl#getLaunchingScripts <em>Launching Scripts</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.ProcessingNodeImpl#getConfigFiles <em>Config Files</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.ProcessingNodeImpl#getCodeFiles <em>Code Files</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.ProcessingNodeImpl#getOwnedMeters <em>Owned Meters</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ProcessingNodeImpl extends PlatformResourceImpl implements ProcessingNode {
	...
	/**
	 * The cached value of the '{@link #getLaunchingScripts() <em>Launching Scripts</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
