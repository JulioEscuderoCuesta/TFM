 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.pasys.impl.OrchestratorDeploymentConfImpl#getImage <em>Image</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.OrchestratorDeploymentConfImpl#getImageTag <em>Image Tag</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.OrchestratorDeploymentConfImpl#getImagePullPolicy <em>Image Pull Policy</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.OrchestratorDeploymentConfImpl#getReplicas <em>Replicas</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.OrchestratorDeploymentConfImpl#getCommand <em>Command</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.OrchestratorDeploymentConfImpl#getArgs <em>Args</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.OrchestratorDeploymentConfImpl#getRestartPolicy <em>Restart Policy</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.OrchestratorDeploymentConfImpl#getEnv <em>Env</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.OrchestratorDeploymentConfImpl#getVolumes <em>Volumes</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.OrchestratorDeploymentConfImpl#getPorts <em>Ports</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.OrchestratorDeploymentConfImpl#getConstraints <em>Constraints</em>}</li>
 * </ul>
 *
 * @generated
 */
