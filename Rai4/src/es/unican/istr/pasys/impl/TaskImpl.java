 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.pasys.impl.TaskImpl#getOwner <em>Owner</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.TaskImpl#getImplementingClassName <em>Implementing Class Name</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.TaskImpl#getReturnedStreamData <em>Returned Stream Data</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.TaskImpl#getTriggerStreamData <em>Trigger Stream Data</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.TaskImpl#getInputStreamData <em>Input Stream Data</em>}</li>
 * </ul>
 *
 * @generated
 */
