 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.pasys.impl.StormServiceImpl#getZookeeperConnect <em>Zookeeper Connect</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.StormServiceImpl#getLocalDir <em>Local Dir</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.StormServiceImpl#getNimbus <em>Nimbus</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.StormServiceImpl#getSupervisor <em>Supervisor</em>}</li>
 *   <li>{@link es.unican.istr.pasys.impl.StormServiceImpl#getUi <em>Ui</em>}</li>
 * </ul>
 *
 * @generated
 */
