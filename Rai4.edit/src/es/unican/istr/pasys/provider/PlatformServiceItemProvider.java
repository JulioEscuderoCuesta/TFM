...
/**
 * This is the item provider adapter for a {@link es.unican.istr.pasys.PlatformService} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PlatformServiceItemProvider extends PlatformResourceItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PlatformService_host_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PlatformService_host_feature", "_UI_PlatformService_type"),
				 PasysPackage.Literals.PLATFORM_SERVICE__HOST,
				 true,
				 false,
				 true,
				 null,
