...
/**
 * This is the item provider adapter for a {@link es.unican.istr.pasys.TaskProcessingAmount} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addMeterPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TaskProcessingAmount_meter_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TaskProcessingAmount_meter_feature", "_UI_TaskProcessingAmount_type"),
				 PasysPackage.Literals.TASK_PROCESSING_AMOUNT__METER,
				 true,
				 false,
				 true,
				 null,
