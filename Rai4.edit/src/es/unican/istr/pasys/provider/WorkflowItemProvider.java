...
/**
 * This is the item provider adapter for a {@link es.unican.istr.pasys.Workflow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WorkflowItemProvider extends SystemElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PasysPackage.Literals.WORKFLOW__ROOT_TASK,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PasysPackage.Literals.WORKFLOW__SCHEDULER,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PasysPackage.Literals.WORKFLOW__OWNED_STREAM_DATA);
			childrenFeatures.add(PasysPackage.Literals.WORKFLOW__OWNED_TASKS);
			childrenFeatures.add(PasysPackage.Literals.WORKFLOW__OWNED_TASK_EXECUTORS);
			childrenFeatures.add(PasysPackage.Literals.WORKFLOW__OWNED_METERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PasysPackage.Literals.DEPLOYABLE_COMPONENT__DEPLOYMENT_CONFIG,
				 PasysFactory.eINSTANCE.createOrchestratorDeploymentConf()));
		...
		newChildDescriptors.add
			(createChildParameter
				(PasysPackage.Literals.WORKFLOW__OWNED_STREAM_DATA,
				 PasysFactory.eINSTANCE.createFlowStreamData()));

		newChildDescriptors.add
			(createChildParameter
				(PasysPackage.Literals.WORKFLOW__OWNED_STREAM_DATA,
				 PasysFactory.eINSTANCE.createKafkaFlowStreamData()));

		newChildDescriptors.add
			(createChildParameter
				(PasysPackage.Literals.WORKFLOW__OWNED_STREAM_DATA,
				 PasysFactory.eINSTANCE.createDerivedStreamData()));

		newChildDescriptors.add
			(createChildParameter
				(PasysPackage.Literals.WORKFLOW__OWNED_TASKS,
				 PasysFactory.eINSTANCE.createTask()));

		newChildDescriptors.add
			(createChildParameter
				(PasysPackage.Literals.WORKFLOW__OWNED_TASK_EXECUTORS,
				 PasysFactory.eINSTANCE.createTaskExecutor()));

		newChildDescriptors.add
			(createChildParameter
				(PasysPackage.Literals.WORKFLOW__OWNED_METERS,
				 PasysFactory.eINSTANCE.createWorkflowLatencyMeter()));
	}
