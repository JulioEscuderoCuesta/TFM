...
/**
 * This is the item provider adapter for a {@link es.unican.istr.pasys.Volume} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VolumeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PasysPackage.Literals.VOLUME__SOURCE,
				 true,
				 false,
				 false,
	...
	protected void addTargetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Volume_target_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Volume_target_feature", "_UI_Volume_type"),
				 PasysPackage.Literals.VOLUME__TARGET,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Volume_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Volume_type_feature", "_UI_Volume_type"),
				 PasysPackage.Literals.VOLUME__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addAccessModePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Volume_accessMode_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Volume_accessMode_feature", "_UI_Volume_type"),
				 PasysPackage.Literals.VOLUME__ACCESS_MODE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Volume)object).getSource();
