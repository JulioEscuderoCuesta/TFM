...
public class MyPasysGenerator extends AbstractGenerator {
  ...
  public void generateStormConfigFile(final StormService stormService, final IFileSystemAccess2 fsa) {
    ...
    _builder.newLine();
    {
      ...
      for(final ProcessingNode zookeeperNode : _nodesFromCluster) {
        _builder.append("- \"");
        String _name = zookeeperNode.getName();
        _builder.append(_name);
        _builder.append("\"");
        _builder.newLineIfNotEmpty();
      }
  ...
  public void generateStormScriptFile(final StormService stormService, final IFileSystemAccess2 fsa) {
    final String nimbusScript = this.generateStormScriptContent(stormService, MyPasysGenerator.DeployableComponentType.STORM_NIMBUS);
    final String supervisorScript = this.generateStormScriptContent(stormService, MyPasysGenerator.DeployableComponentType.STORM_SUPERVISOR);
    final String uiScript = this.generateStormScriptContent(stormService, MyPasysGenerator.DeployableComponentType.STORM_UI);
  ...
  public String generateStormScriptContent(final StormService stormService, final MyPasysGenerator.DeployableComponentType type) {
  ...
  public String toScriptCommand(final MyPasysGenerator.DeployableComponentType type) {
    String _switchResult = null;
    if (type != null) {
      switch (type) {
        case STORM_NIMBUS:
  ...
  public void generateZookeeperConfigFile(final ZookeeperService zkService, final IFileSystemAccess2 fsa) {
    ...
    _builder_1.newLineIfNotEmpty();
    _builder_1.newLine();
    _builder_1.append("# Server definitions");
    _builder_1.newLine();
    _builder_1.append("# Server ID (used for leader election)");
    _builder_1.newLine();
    _builder_1.append("myid=");
    int _serverId = zkService.getServerId();
    _builder_1.append(_serverId);
    _builder_1.newLineIfNotEmpty();
    _builder_1.newLine();
