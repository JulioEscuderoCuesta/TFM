...
public class DeploymentTool {
	...
	public static void main(String[] args) {
		...
		try {
			...
			for (es.unican.istr.rai4.SystemElement elem : system.getOwnedElements()) {
				if (elem instanceof es.unican.istr.rai4.impl.ProcessingNodeImpl) {
					es.unican.istr.rai4.impl.ProcessingNodeImpl node = (es.unican.istr.rai4.impl.ProcessingNodeImpl) elem;
					muestraNodo(node);
				}
			}
	...
	private static void muestraNodo(es.unican.istr.rai4.impl.ProcessingNodeImpl node) {
		...
		for (es.unican.istr.rai4.DeploymentFileDescriptor f : node.getConfigFiles()) {
			System.out.println();
