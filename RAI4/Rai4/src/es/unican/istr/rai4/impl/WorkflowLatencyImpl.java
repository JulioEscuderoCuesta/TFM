 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.rai4.impl.WorkflowLatencyImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkflowLatencyImpl extends MetricImpl implements WorkflowLatency {
	...
	protected EClass eStaticClass() {
		return Rai4Package.Literals.WORKFLOW_LATENCY;
	}
		...
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Rai4Package.WORKFLOW_LATENCY__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(Workflow newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.WORKFLOW_LATENCY__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Rai4Package.WORKFLOW_LATENCY__TARGET:
