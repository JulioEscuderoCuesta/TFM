 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.rai4.impl.FlowStreamDataImpl#getSource <em>Source</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.FlowStreamDataImpl#getPredecessor <em>Predecessor</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.FlowStreamDataImpl#getHolder <em>Holder</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.FlowStreamDataImpl#isIsImplemented <em>Is Implemented</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FlowStreamDataImpl extends WorkflowStreamDataImpl implements FlowStreamData {
	...
	protected EClass eStaticClass() {
		return Rai4Package.Literals.FLOW_STREAM_DATA;
	}
		...
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Rai4Package.FLOW_STREAM_DATA__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(StreamData newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.FLOW_STREAM_DATA__SOURCE, oldSource, source));
	}
	...
	public StreamData getPredecessor() {
		if (predecessor != null && predecessor.eIsProxy()) {
			...
			if (predecessor != oldPredecessor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Rai4Package.FLOW_STREAM_DATA__PREDECESSOR, oldPredecessor, predecessor));
			}
		}
		return predecessor;
	}
	...
	public void setPredecessor(StreamData newPredecessor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.FLOW_STREAM_DATA__PREDECESSOR, oldPredecessor, predecessor));
	}
	...
	public CommunicationService getHolder() {
		if (holder != null && holder.eIsProxy()) {
			...
			if (holder != oldHolder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Rai4Package.FLOW_STREAM_DATA__HOLDER, oldHolder, holder));
			}
		}
		return holder;
	}
	...
	public void setHolder(CommunicationService newHolder) {
		...
		holder = newHolder;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.FLOW_STREAM_DATA__HOLDER, oldHolder, holder));
	}
	...
	public void setIsImplemented(boolean newIsImplemented) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.FLOW_STREAM_DATA__IS_IMPLEMENTED, oldIsImplemented, isImplemented));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Rai4Package.FLOW_STREAM_DATA__SOURCE:
				if (resolve) return getSource();
				return basicGetSource();
			case Rai4Package.FLOW_STREAM_DATA__PREDECESSOR:
				if (resolve) return getPredecessor();
				return basicGetPredecessor();
			case Rai4Package.FLOW_STREAM_DATA__HOLDER:
				if (resolve) return getHolder();
				return basicGetHolder();
			case Rai4Package.FLOW_STREAM_DATA__IS_IMPLEMENTED:
