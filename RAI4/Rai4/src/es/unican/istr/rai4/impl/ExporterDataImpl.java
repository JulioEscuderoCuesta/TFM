 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.rai4.impl.ExporterDataImpl#getName <em>Name</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.ExporterDataImpl#getArtifact <em>Artifact</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExporterDataImpl extends MinimalEObjectImpl.Container implements ExporterData {
	...
	protected EClass eStaticClass() {
		return Rai4Package.Literals.EXPORTER_DATA;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.EXPORTER_DATA__NAME, oldName, name));
	}
	...
	public void setArtifact(String newArtifact) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.EXPORTER_DATA__ARTIFACT, oldArtifact, artifact));
	}
