 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.rai4.impl.SparkServiceImpl#getLoad <em>Load</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.SparkServiceImpl#getDriverCores <em>Driver Cores</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.SparkServiceImpl#getDriverMaxResultSize <em>Driver Max Result Size</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.SparkServiceImpl#getDriverMemory <em>Driver Memory</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.SparkServiceImpl#getLocalDir <em>Local Dir</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.SparkServiceImpl#getMaster <em>Master</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.SparkServiceImpl#getWindowSize <em>Window Size</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.SparkServiceImpl#getExecutorMemory <em>Executor Memory</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.SparkServiceImpl#getExtraListener <em>Extra Listener</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.SparkServiceImpl#isLogConf <em>Log Conf</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.SparkServiceImpl#getSubmitDeployMode <em>Submit Deploy Mode</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.SparkServiceImpl#getLogCallerContext <em>Log Caller Context</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.SparkServiceImpl#isDriverSuperviser <em>Driver Superviser</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SparkServiceImpl extends SchedulingServiceImpl implements SparkService {
	...
	protected EClass eStaticClass() {
		return Rai4Package.Literals.SPARK_SERVICE;
	}
		...
		if (load != null && load.eIsProxy()) {
			...
			if (load != oldLoad) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Rai4Package.SPARK_SERVICE__LOAD, oldLoad, load));
			}
		}
		return load;
	}
	...
	public void setLoad(SchedulableSet newLoad) {
		...
		load = newLoad;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.SPARK_SERVICE__LOAD, oldLoad, load));
	}
	...
	public void setDriverCores(int newDriverCores) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.SPARK_SERVICE__DRIVER_CORES, oldDriverCores, driverCores));
	}
	...
	public void setDriverMaxResultSize(String newDriverMaxResultSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.SPARK_SERVICE__DRIVER_MAX_RESULT_SIZE, oldDriverMaxResultSize, driverMaxResultSize));
	}
	...
	public void setDriverMemory(long newDriverMemory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.SPARK_SERVICE__DRIVER_MEMORY, oldDriverMemory, driverMemory));
	}
	...
	public void setLocalDir(String newLocalDir) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.SPARK_SERVICE__LOCAL_DIR, oldLocalDir, localDir));
	}
	...
	public ProcessingResourceCluster getMaster() {
		if (master != null && master.eIsProxy()) {
			...
			if (master != oldMaster) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Rai4Package.SPARK_SERVICE__MASTER, oldMaster, master));
			}
		}
		return master;
	}
	...
	public void setMaster(ProcessingResourceCluster newMaster) {
		...
		master = newMaster;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.SPARK_SERVICE__MASTER, oldMaster, master));
	}
	...
	public void setWindowSize(int newWindowSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.SPARK_SERVICE__WINDOW_SIZE, oldWindowSize, windowSize));
	}
	...
	public void setExecutorMemory(long newExecutorMemory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.SPARK_SERVICE__EXECUTOR_MEMORY, oldExecutorMemory, executorMemory));
	}
	...
	public void setExtraListener(String newExtraListener) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.SPARK_SERVICE__EXTRA_LISTENER, oldExtraListener, extraListener));
	}
	...
	public void setLogConf(boolean newLogConf) {
		...
		logConf = newLogConf;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.SPARK_SERVICE__LOG_CONF, oldLogConf, logConf));
	}
	...
	public void setSubmitDeployMode(String newSubmitDeployMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.SPARK_SERVICE__SUBMIT_DEPLOY_MODE, oldSubmitDeployMode, submitDeployMode));
	}
	...
	public void setLogCallerContext(String newLogCallerContext) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.SPARK_SERVICE__LOG_CALLER_CONTEXT, oldLogCallerContext, logCallerContext));
	}
	...
	public void setDriverSuperviser(boolean newDriverSuperviser) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.SPARK_SERVICE__DRIVER_SUPERVISER, oldDriverSuperviser, driverSuperviser));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Rai4Package.SPARK_SERVICE__LOAD:
				if (resolve) return getLoad();
				return basicGetLoad();
			case Rai4Package.SPARK_SERVICE__DRIVER_CORES:
				return getDriverCores();
			case Rai4Package.SPARK_SERVICE__DRIVER_MAX_RESULT_SIZE:
				return getDriverMaxResultSize();
			case Rai4Package.SPARK_SERVICE__DRIVER_MEMORY:
				return getDriverMemory();
			case Rai4Package.SPARK_SERVICE__LOCAL_DIR:
				return getLocalDir();
			case Rai4Package.SPARK_SERVICE__MASTER:
				if (resolve) return getMaster();
				return basicGetMaster();
			case Rai4Package.SPARK_SERVICE__WINDOW_SIZE:
				return getWindowSize();
			case Rai4Package.SPARK_SERVICE__EXECUTOR_MEMORY:
				return getExecutorMemory();
			case Rai4Package.SPARK_SERVICE__EXTRA_LISTENER:
				return getExtraListener();
			case Rai4Package.SPARK_SERVICE__LOG_CONF:
				return isLogConf();
			case Rai4Package.SPARK_SERVICE__SUBMIT_DEPLOY_MODE:
				return getSubmitDeployMode();
			case Rai4Package.SPARK_SERVICE__LOG_CALLER_CONTEXT:
				return getLogCallerContext();
			case Rai4Package.SPARK_SERVICE__DRIVER_SUPERVISER:
