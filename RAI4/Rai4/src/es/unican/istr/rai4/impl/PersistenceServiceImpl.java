 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.rai4.impl.PersistenceServiceImpl#getLogging <em>Logging</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.PersistenceServiceImpl#getPasswd <em>Passwd</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.PersistenceServiceImpl#getPort <em>Port</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PersistenceServiceImpl extends PlatformServiceImpl implements PersistenceService {
	...
	protected EClass eStaticClass() {
		return Rai4Package.Literals.PERSISTENCE_SERVICE;
	}
	...
	public void setLogging(String newLogging) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.PERSISTENCE_SERVICE__LOGGING, oldLogging, logging));
	}
	...
	public void setPasswd(String newPasswd) {
		...
		passwd = newPasswd;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.PERSISTENCE_SERVICE__PASSWD, oldPasswd, passwd));
	}
	...
	public void setPort(int newPort) {
		...
		port = newPort;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.PERSISTENCE_SERVICE__PORT, oldPort, port));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Rai4Package.PERSISTENCE_SERVICE__LOGGING:
				return getLogging();
			case Rai4Package.PERSISTENCE_SERVICE__PASSWD:
				return getPasswd();
			case Rai4Package.PERSISTENCE_SERVICE__PORT:
				return getPort();
		}
