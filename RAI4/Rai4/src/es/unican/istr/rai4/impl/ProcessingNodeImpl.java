 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.rai4.impl.ProcessingNodeImpl#getIp <em>Ip</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.ProcessingNodeImpl#getOs <em>Os</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.ProcessingNodeImpl#getConcurrencyLevel <em>Concurrency Level</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.ProcessingNodeImpl#getMemorySize <em>Memory Size</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.ProcessingNodeImpl#getSpeedFactor <em>Speed Factor</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.ProcessingNodeImpl#getConfigData <em>Config Data</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.ProcessingNodeImpl#getUserName <em>User Name</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.ProcessingNodeImpl#getConnectedTo <em>Connected To</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.ProcessingNodeImpl#getLaunchingScripts <em>Launching Scripts</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.ProcessingNodeImpl#getConfigFiles <em>Config Files</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.ProcessingNodeImpl#getCodeFiles <em>Code Files</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.ProcessingNodeImpl#getOwnedMeters <em>Owned Meters</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ProcessingNodeImpl extends PlatformResourceImpl implements ProcessingNode {
	...
	protected EClass eStaticClass() {
		return Rai4Package.Literals.PROCESSING_NODE;
	}
	...
	public void setIp(String newIp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.PROCESSING_NODE__IP, oldIp, ip));
	}
	...
	public void setOs(String newOs) {
		...
		os = newOs;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.PROCESSING_NODE__OS, oldOs, os));
	}
	...
	public void setConcurrencyLevel(int newConcurrencyLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.PROCESSING_NODE__CONCURRENCY_LEVEL, oldConcurrencyLevel, concurrencyLevel));
	}
	...
	public void setMemorySize(int newMemorySize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.PROCESSING_NODE__MEMORY_SIZE, oldMemorySize, memorySize));
	}
	...
	public void setSpeedFactor(double newSpeedFactor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.PROCESSING_NODE__SPEED_FACTOR, oldSpeedFactor, speedFactor));
	}
	...
	public void setConfigData(Properties newConfigData) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.PROCESSING_NODE__CONFIG_DATA, oldConfigData, configData));
	}
	...
	public void setUserName(String newUserName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.PROCESSING_NODE__USER_NAME, oldUserName, userName));
	}
	...
	public EList<Network> getConnectedTo() {
		if (connectedTo == null) {
			connectedTo = new EObjectResolvingEList<Network>(Network.class, this, Rai4Package.PROCESSING_NODE__CONNECTED_TO);
		}
		return connectedTo;
	}
	...
	public EList<DeploymentFileDescriptor> getLaunchingScripts() {
		if (launchingScripts == null) {
			launchingScripts = new EObjectContainmentEList<DeploymentFileDescriptor>(DeploymentFileDescriptor.class, this, Rai4Package.PROCESSING_NODE__LAUNCHING_SCRIPTS);
		}
	...
	public EList<DeploymentFileDescriptor> getConfigFiles() {
		if (configFiles == null) {
			configFiles = new EObjectContainmentEList<DeploymentFileDescriptor>(DeploymentFileDescriptor.class, this, Rai4Package.PROCESSING_NODE__CONFIG_FILES);
		}
		return configFiles;
	}
	...
	public EList<ArtifactDescriptor> getCodeFiles() {
		if (codeFiles == null) {
			codeFiles = new EObjectContainmentEList<ArtifactDescriptor>(ArtifactDescriptor.class, this, Rai4Package.PROCESSING_NODE__CODE_FILES);
		}
		return codeFiles;
	}
	...
	public EList<NodeHostedMeter> getOwnedMeters() {
		if (ownedMeters == null) {
			ownedMeters = new EObjectContainmentWithInverseEList<NodeHostedMeter>(NodeHostedMeter.class, this, Rai4Package.PROCESSING_NODE__OWNED_METERS, Rai4Package.NODE_HOSTED_METER__OWNER);
		}
		return ownedMeters;
	}
	 ...
	 */
	@Override
	public void deployAndLaunch() throws LaunchException, DeploymentException {
		// TODO: implement this method
		// Ensure that you remove @generated or mark it @generated NOT
		throw new UnsupportedOperationException();
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Rai4Package.PROCESSING_NODE__OWNED_METERS:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Rai4Package.PROCESSING_NODE__LAUNCHING_SCRIPTS:
				return ((InternalEList<?>)getLaunchingScripts()).basicRemove(otherEnd, msgs);
			case Rai4Package.PROCESSING_NODE__CONFIG_FILES:
				return ((InternalEList<?>)getConfigFiles()).basicRemove(otherEnd, msgs);
			case Rai4Package.PROCESSING_NODE__CODE_FILES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Rai4Package.PROCESSING_NODE__IP:
				return getIp();
			case Rai4Package.PROCESSING_NODE__OS:
				return getOs();
			case Rai4Package.PROCESSING_NODE__CONCURRENCY_LEVEL:
				return getConcurrencyLevel();
			case Rai4Package.PROCESSING_NODE__MEMORY_SIZE:
				return getMemorySize();
			case Rai4Package.PROCESSING_NODE__SPEED_FACTOR:
				return getSpeedFactor();
			case Rai4Package.PROCESSING_NODE__CONFIG_DATA:
				return getConfigData();
			case Rai4Package.PROCESSING_NODE__USER_NAME:
				return getUserName();
			case Rai4Package.PROCESSING_NODE__CONNECTED_TO:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Rai4Package.PROCESSING_NODE___PREPARE_FOR_DEPLOYMENT:
				try {
			...
			case Rai4Package.PROCESSING_NODE___DEPLOY_AND_LAUNCH:
				try {
					deployAndLaunch();
					return null;
				}
			...
			case Rai4Package.PROCESSING_NODE___BRING_BACK_CONFIGURATION:
				bringBackConfiguration();
				return null;
			case Rai4Package.PROCESSING_NODE___BRING_BACK_DEPLOYMENT:
				bringBackDeployment();
				return null;
			case Rai4Package.PROCESSING_NODE___ABORT_LAUNCHING:
				abortLaunching();
				return null;
			case Rai4Package.PROCESSING_NODE___ADD_LAUNCHING_SCRIPT__DEPLOYMENTFILEDESCRIPTOR:
				addLaunchingScript((DeploymentFileDescriptor)arguments.get(0));
				return null;
			case Rai4Package.PROCESSING_NODE___ADD_CONFIG_FILE__DEPLOYMENTFILEDESCRIPTOR:
