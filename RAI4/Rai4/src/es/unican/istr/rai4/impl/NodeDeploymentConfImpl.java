 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.rai4.impl.NodeDeploymentConfImpl#getArguments <em>Arguments</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.NodeDeploymentConfImpl#getArtifactLocator <em>Artifact Locator</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.NodeDeploymentConfImpl#getArtifactName <em>Artifact Name</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.NodeDeploymentConfImpl#getConfigFolderPath <em>Config Folder Path</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.NodeDeploymentConfImpl#getScriptFolderPath <em>Script Folder Path</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.NodeDeploymentConfImpl#getDataFolderPath <em>Data Folder Path</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.NodeDeploymentConfImpl#getLogFolderPath <em>Log Folder Path</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.NodeDeploymentConfImpl#getCodeFolderPath <em>Code Folder Path</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.NodeDeploymentConfImpl#isIsRunning <em>Is Running</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NodeDeploymentConfImpl extends PlatformServiceDeploymentConfImpl implements NodeDeploymentConf {
	...
	protected EClass eStaticClass() {
		return Rai4Package.Literals.NODE_DEPLOYMENT_CONF;
	}
	...
	public EList<String> getArguments() {
		if (arguments == null) {
			arguments = new EDataTypeUniqueEList<String>(String.class, this, Rai4Package.NODE_DEPLOYMENT_CONF__ARGUMENTS);
		}
		return arguments;
	}
	...
	public void setArtifactLocator(String newArtifactLocator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.NODE_DEPLOYMENT_CONF__ARTIFACT_LOCATOR, oldArtifactLocator, artifactLocator));
	}
	...
	public void setArtifactName(String newArtifactName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.NODE_DEPLOYMENT_CONF__ARTIFACT_NAME, oldArtifactName, artifactName));
	}
	...
	public void setConfigFolderPath(String newConfigFolderPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.NODE_DEPLOYMENT_CONF__CONFIG_FOLDER_PATH, oldConfigFolderPath, configFolderPath));
	}
	...
	public void setScriptFolderPath(String newScriptFolderPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.NODE_DEPLOYMENT_CONF__SCRIPT_FOLDER_PATH, oldScriptFolderPath, scriptFolderPath));
	}
	...
	public void setDataFolderPath(String newDataFolderPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.NODE_DEPLOYMENT_CONF__DATA_FOLDER_PATH, oldDataFolderPath, dataFolderPath));
	}
	...
	public void setLogFolderPath(String newLogFolderPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.NODE_DEPLOYMENT_CONF__LOG_FOLDER_PATH, oldLogFolderPath, logFolderPath));
	}
	...
	public void setCodeFolderPath(String newCodeFolderPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.NODE_DEPLOYMENT_CONF__CODE_FOLDER_PATH, oldCodeFolderPath, codeFolderPath));
	}
	...
	public void setIsRunning(boolean newIsRunning) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.NODE_DEPLOYMENT_CONF__IS_RUNNING, oldIsRunning, isRunning));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Rai4Package.NODE_DEPLOYMENT_CONF__ARGUMENTS:
				return getArguments();
			case Rai4Package.NODE_DEPLOYMENT_CONF__ARTIFACT_LOCATOR:
				return getArtifactLocator();
			case Rai4Package.NODE_DEPLOYMENT_CONF__ARTIFACT_NAME:
				return getArtifactName();
			case Rai4Package.NODE_DEPLOYMENT_CONF__CONFIG_FOLDER_PATH:
				return getConfigFolderPath();
			case Rai4Package.NODE_DEPLOYMENT_CONF__SCRIPT_FOLDER_PATH:
				return getScriptFolderPath();
			case Rai4Package.NODE_DEPLOYMENT_CONF__DATA_FOLDER_PATH:
				return getDataFolderPath();
			case Rai4Package.NODE_DEPLOYMENT_CONF__LOG_FOLDER_PATH:
				return getLogFolderPath();
			case Rai4Package.NODE_DEPLOYMENT_CONF__CODE_FOLDER_PATH:
				return getCodeFolderPath();
			case Rai4Package.NODE_DEPLOYMENT_CONF__IS_RUNNING:
				return isIsRunning();
		}
