 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.rai4.impl.AWSVirtualProcessingNodeImpl#getVpc <em>Vpc</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.AWSVirtualProcessingNodeImpl#getSubNet <em>Sub Net</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.AWSVirtualProcessingNodeImpl#getKeyPair <em>Key Pair</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.AWSVirtualProcessingNodeImpl#getSecurityGroup <em>Security Group</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.AWSVirtualProcessingNodeImpl#getAMI <em>AMI</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.AWSVirtualProcessingNodeImpl#getInstanceType <em>Instance Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AWSVirtualProcessingNodeImpl extends VirtualProcessingNodeImpl implements AWSVirtualProcessingNode {
	...
	protected EClass eStaticClass() {
		return Rai4Package.Literals.AWS_VIRTUAL_PROCESSING_NODE;
	}
	...
	public void setVpc(String newVpc) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.AWS_VIRTUAL_PROCESSING_NODE__VPC, oldVpc, vpc));
	}
	...
	public void setSubNet(String newSubNet) {
		...
		subNet = newSubNet;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.AWS_VIRTUAL_PROCESSING_NODE__SUB_NET, oldSubNet, subNet));
	}
	...
	public void setKeyPair(String newKeyPair) {
		...
		keyPair = newKeyPair;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.AWS_VIRTUAL_PROCESSING_NODE__KEY_PAIR, oldKeyPair, keyPair));
	}
	...
	public void setSecurityGroup(String newSecurityGroup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.AWS_VIRTUAL_PROCESSING_NODE__SECURITY_GROUP, oldSecurityGroup, securityGroup));
	}
	...
	public void setAMI(String newAMI) {
		...
		ami = newAMI;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.AWS_VIRTUAL_PROCESSING_NODE__AMI, oldAMI, ami));
	}
	...
	public void setInstanceType(String newInstanceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.AWS_VIRTUAL_PROCESSING_NODE__INSTANCE_TYPE, oldInstanceType, instanceType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Rai4Package.AWS_VIRTUAL_PROCESSING_NODE__VPC:
				return getVpc();
			case Rai4Package.AWS_VIRTUAL_PROCESSING_NODE__SUB_NET:
				return getSubNet();
			case Rai4Package.AWS_VIRTUAL_PROCESSING_NODE__KEY_PAIR:
				return getKeyPair();
			case Rai4Package.AWS_VIRTUAL_PROCESSING_NODE__SECURITY_GROUP:
				return getSecurityGroup();
			case Rai4Package.AWS_VIRTUAL_PROCESSING_NODE__AMI:
				return getAMI();
			case Rai4Package.AWS_VIRTUAL_PROCESSING_NODE__INSTANCE_TYPE:
