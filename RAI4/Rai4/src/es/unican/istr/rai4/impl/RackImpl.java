 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.rai4.impl.RackImpl#getNodes <em>Nodes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RackImpl extends NamedElementImpl implements Rack {
	...
	protected EClass eStaticClass() {
		return Rai4Package.Literals.RACK;
	}
		...
		if (nodes != null && nodes.eIsProxy()) {
			...
			if (nodes != oldNodes) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Rai4Package.RACK__NODES, oldNodes, nodes));
			}
		}
		return nodes;
	}
	...
	public void setNodes(ProcessingNodeCluster newNodes) {
		...
		nodes = newNodes;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.RACK__NODES, oldNodes, nodes));
	}
