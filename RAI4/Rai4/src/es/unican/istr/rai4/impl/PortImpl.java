 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.rai4.impl.PortImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.PortImpl#getPublished <em>Published</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PortImpl extends MinimalEObjectImpl.Container implements Port {
	...
	protected EClass eStaticClass() {
		return Rai4Package.Literals.PORT;
	}
	...
	public void setTarget(String newTarget) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.PORT__TARGET, oldTarget, target));
	}
	...
	public void setPublished(String newPublished) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.PORT__PUBLISHED, oldPublished, published));
	}
