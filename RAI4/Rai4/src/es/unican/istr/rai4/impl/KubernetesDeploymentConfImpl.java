 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.rai4.impl.KubernetesDeploymentConfImpl#getExternalIP <em>External IP</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.KubernetesDeploymentConfImpl#getServiceType <em>Service Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class KubernetesDeploymentConfImpl extends OrchestratorDeploymentConfImpl implements KubernetesDeploymentConf {
	...
	protected EClass eStaticClass() {
		return Rai4Package.Literals.KUBERNETES_DEPLOYMENT_CONF;
	}
	...
	public void setExternalIP(String newExternalIP) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.KUBERNETES_DEPLOYMENT_CONF__EXTERNAL_IP, oldExternalIP, externalIP));
	}
	...
	public void setServiceType(ServiceType newServiceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.KUBERNETES_DEPLOYMENT_CONF__SERVICE_TYPE, oldServiceType, serviceType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Rai4Package.KUBERNETES_DEPLOYMENT_CONF__EXTERNAL_IP:
				return getExternalIP();
			case Rai4Package.KUBERNETES_DEPLOYMENT_CONF__SERVICE_TYPE:
