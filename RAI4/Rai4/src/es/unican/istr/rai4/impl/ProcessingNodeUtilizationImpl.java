 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.rai4.impl.ProcessingNodeUtilizationImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProcessingNodeUtilizationImpl extends MetricImpl implements ProcessingNodeUtilization {
	...
	protected EClass eStaticClass() {
		return Rai4Package.Literals.PROCESSING_NODE_UTILIZATION;
	}
		...
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Rai4Package.PROCESSING_NODE_UTILIZATION__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(ProcessingNode newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.PROCESSING_NODE_UTILIZATION__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Rai4Package.PROCESSING_NODE_UTILIZATION__TARGET:
