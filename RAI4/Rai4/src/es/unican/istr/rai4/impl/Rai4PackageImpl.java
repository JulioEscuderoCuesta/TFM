 ...
 * @generated
 */
public class Rai4PackageImpl extends EPackageImpl implements Rai4Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see es.unican.istr.rai4.Rai4Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Rai4PackageImpl() {
		super(eNS_URI, Rai4Factory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link Rai4Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Rai4Package init() {
		if (isInited) return (Rai4Package)EPackage.Registry.INSTANCE.getEPackage(Rai4Package.eNS_URI);

		// Obtain or create and register package
		Object registeredRai4Package = EPackage.Registry.INSTANCE.get(eNS_URI);
		Rai4PackageImpl theRai4Package = registeredRai4Package instanceof Rai4PackageImpl ? (Rai4PackageImpl)registeredRai4Package : new Rai4PackageImpl();

		isInited = true;

		// Create package meta-data objects
		theRai4Package.createPackageContents();

		// Initialize created meta-data
		theRai4Package.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theRai4Package.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Rai4Package.eNS_URI, theRai4Package);
		return theRai4Package;
	}
	...
	public EAttribute getTaskProcessingAmount_HistogramBuckectNum() {
		return (EAttribute)taskProcessingAmountEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public Rai4Factory getRai4Factory() {
		return (Rai4Factory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getZookeeperService_ClientPort(), ecorePackage.getEString(), "clientPort", "2181", 1, 1, ZookeeperService.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getZookeeperService_PeerPort(), ecorePackage.getEString(), "peerPort", "2888", 1, 1, ZookeeperService.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getZookeeperService_LeaderPort(), ecorePackage.getEString(), "leaderPort", "3888", 1, 1, ZookeeperService.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getKafkaService_ClientPort(), ecorePackage.getEString(), "clientPort", "9092", 1, 1, KafkaService.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getStormUI_UiPort(), ecorePackage.getEString(), "uiPort", "8080", 1, 1, StormUI.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCassandraService_StoragePort(), ecorePackage.getEString(), "storagePort", "7000", 1, 1, CassandraService.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCassandraService_SslStoragePort(), ecorePackage.getEString(), "sslStoragePort", "7001", 1, 1, CassandraService.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCassandraService_RpcPort(), ecorePackage.getEString(), "rpcPort", "9160", 1, 1, CassandraService.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getProcessingNodeUtilization_Target(), this.getProcessingNode(), null, "target", null, 0, 1, ProcessingNodeUtilization.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getProcessingNodeMemory_Target(), this.getProcessingNode(), null, "target", null, 0, 1, ProcessingNodeMemory.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getPrometheusMeter_MonitoringPort(), ecorePackage.getEString(), "monitoringPort", null, 1, 1, PrometheusMeter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getNodeResourceMeter_UMetric(), this.getProcessingNodeUtilization(), null, "uMetric", null, 1, 1, NodeResourceMeter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getNodeResourceMeter_MMetric(), this.getProcessingNodeMemory(), null, "mMetric", null, 1, 1, NodeResourceMeter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCommunicationMeter_Metric(), this.getNetworkUtilization(), null, "metric", null, 1, 1, CommunicationMeter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getStreamRateMeter_Metric(), this.getStreamDataRate(), null, "metric", null, 1, 1, StreamRateMeter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getWorkflowLatencyMeter_Metric(), this.getWorkflowLatency(), null, "metric", null, 0, 1, WorkflowLatencyMeter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTaskProcessingAmountMeter_Metric(), this.getTaskProcessingAmount(), null, "metric", null, 1, 1, TaskProcessingAmountMeter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
