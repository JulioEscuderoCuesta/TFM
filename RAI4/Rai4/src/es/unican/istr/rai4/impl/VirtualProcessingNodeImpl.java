 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.rai4.impl.VirtualProcessingNodeImpl#getExternalIP <em>External IP</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class VirtualProcessingNodeImpl extends ProcessingNodeImpl implements VirtualProcessingNode {
	...
	protected EClass eStaticClass() {
		return Rai4Package.Literals.VIRTUAL_PROCESSING_NODE;
	}
	...
	public void setExternalIP(String newExternalIP) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.VIRTUAL_PROCESSING_NODE__EXTERNAL_IP, oldExternalIP, externalIP));
	}
