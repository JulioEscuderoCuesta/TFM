 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.rai4.impl.TaskProcessingAmountImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.TaskProcessingAmountImpl#getHistogramBuckectNum <em>Histogram Buckect Num</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.TaskProcessingAmountImpl#getExpectedMaxTPA <em>Expected Max TPA</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.TaskProcessingAmountImpl#getExpectedMinTPA <em>Expected Min TPA</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.TaskProcessingAmountImpl#isLinearBucketDistribution <em>Linear Bucket Distribution</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TaskProcessingAmountImpl extends MetricImpl implements TaskProcessingAmount {
	...
	protected EClass eStaticClass() {
		return Rai4Package.Literals.TASK_PROCESSING_AMOUNT;
	}
		...
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Rai4Package.TASK_PROCESSING_AMOUNT__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(Task newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.TASK_PROCESSING_AMOUNT__TARGET, oldTarget, target));
	}
	...
	public void setHistogramBuckectNum(int newHistogramBuckectNum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.TASK_PROCESSING_AMOUNT__HISTOGRAM_BUCKECT_NUM, oldHistogramBuckectNum, histogramBuckectNum));
	}
	...
	public void setExpectedMaxTPA(long newExpectedMaxTPA) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.TASK_PROCESSING_AMOUNT__EXPECTED_MAX_TPA, oldExpectedMaxTPA, expectedMaxTPA));
	}
	...
	public void setExpectedMinTPA(long newExpectedMinTPA) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.TASK_PROCESSING_AMOUNT__EXPECTED_MIN_TPA, oldExpectedMinTPA, expectedMinTPA));
	}
	...
	public void setLinearBucketDistribution(boolean newLinearBucketDistribution) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.TASK_PROCESSING_AMOUNT__LINEAR_BUCKET_DISTRIBUTION, oldLinearBucketDistribution, linearBucketDistribution));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Rai4Package.TASK_PROCESSING_AMOUNT__TARGET:
				if (resolve) return getTarget();
				return basicGetTarget();
			case Rai4Package.TASK_PROCESSING_AMOUNT__HISTOGRAM_BUCKECT_NUM:
				return getHistogramBuckectNum();
			case Rai4Package.TASK_PROCESSING_AMOUNT__EXPECTED_MAX_TPA:
				return getExpectedMaxTPA();
			case Rai4Package.TASK_PROCESSING_AMOUNT__EXPECTED_MIN_TPA:
				return getExpectedMinTPA();
			case Rai4Package.TASK_PROCESSING_AMOUNT__LINEAR_BUCKET_DISTRIBUTION:
