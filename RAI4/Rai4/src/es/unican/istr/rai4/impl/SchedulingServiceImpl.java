 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.rai4.impl.SchedulingServiceImpl#getWorkflows <em>Workflows</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class SchedulingServiceImpl extends PlatformServiceImpl implements SchedulingService {
	...
	protected EClass eStaticClass() {
		return Rai4Package.Literals.SCHEDULING_SERVICE;
	}
	...
	public EList<Workflow> getWorkflows() {
		if (workflows == null) {
			workflows = new EObjectWithInverseResolvingEList<Workflow>(Workflow.class, this, Rai4Package.SCHEDULING_SERVICE__WORKFLOWS, Rai4Package.WORKFLOW__SCHEDULER);
		}
		return workflows;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Rai4Package.SCHEDULING_SERVICE__WORKFLOWS:
