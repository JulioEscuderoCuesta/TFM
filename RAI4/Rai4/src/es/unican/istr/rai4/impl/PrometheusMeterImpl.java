...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Prometheus Meter</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.rai4.impl.PrometheusMeterImpl#getMonitoringPort <em>Monitoring Port</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.PrometheusMeterImpl#getMonitoringTime <em>Monitoring Time</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrometheusMeterImpl extends MeterImpl implements PrometheusMeter {
	 ...
	 * @ordered
	 */
	protected static final String MONITORING_PORT_EDEFAULT = null;
	 ...
	 * @ordered
	 */
	protected String monitoringPort = MONITORING_PORT_EDEFAULT;
	...
	protected EClass eStaticClass() {
		return Rai4Package.Literals.PROMETHEUS_METER;
	}
	 ...
	 */
	@Override
	public void setMonitoringPort(String newMonitoringPort) {
		String oldMonitoringPort = monitoringPort;
		monitoringPort = newMonitoringPort;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.PROMETHEUS_METER__MONITORING_PORT, oldMonitoringPort, monitoringPort));
	}
	...
	public void setMonitoringTime(long newMonitoringTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.PROMETHEUS_METER__MONITORING_TIME, oldMonitoringTime, monitoringTime));
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case Rai4Package.PROMETHEUS_METER__MONITORING_PORT:
				setMonitoringPort((String)newValue);
				return;
			case Rai4Package.PROMETHEUS_METER__MONITORING_TIME:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case Rai4Package.PROMETHEUS_METER__MONITORING_PORT:
				return MONITORING_PORT_EDEFAULT == null ? monitoringPort != null : !MONITORING_PORT_EDEFAULT.equals(monitoringPort);
			case Rai4Package.PROMETHEUS_METER__MONITORING_TIME:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Rai4Package.PROMETHEUS_METER___GET_PROMETHEUS_SERVER_CONFIGURATION:
