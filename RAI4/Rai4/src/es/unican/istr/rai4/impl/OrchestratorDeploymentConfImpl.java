 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.rai4.impl.OrchestratorDeploymentConfImpl#getImage <em>Image</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.OrchestratorDeploymentConfImpl#getImageTag <em>Image Tag</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.OrchestratorDeploymentConfImpl#getImagePullPolicy <em>Image Pull Policy</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.OrchestratorDeploymentConfImpl#getReplicas <em>Replicas</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.OrchestratorDeploymentConfImpl#getCommand <em>Command</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.OrchestratorDeploymentConfImpl#getArgs <em>Args</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.OrchestratorDeploymentConfImpl#getRestartPolicy <em>Restart Policy</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.OrchestratorDeploymentConfImpl#getEnv <em>Env</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.OrchestratorDeploymentConfImpl#getVolumes <em>Volumes</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.OrchestratorDeploymentConfImpl#getPorts <em>Ports</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.OrchestratorDeploymentConfImpl#getConstraints <em>Constraints</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class OrchestratorDeploymentConfImpl extends PlatformServiceDeploymentConfImpl implements OrchestratorDeploymentConf {
	...
	protected EClass eStaticClass() {
		return Rai4Package.Literals.ORCHESTRATOR_DEPLOYMENT_CONF;
	}
	...
	public void setImage(String newImage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.ORCHESTRATOR_DEPLOYMENT_CONF__IMAGE, oldImage, image));
	}
	...
	public void setImageTag(String newImageTag) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.ORCHESTRATOR_DEPLOYMENT_CONF__IMAGE_TAG, oldImageTag, imageTag));
	}
	...
	public void setImagePullPolicy(String newImagePullPolicy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.ORCHESTRATOR_DEPLOYMENT_CONF__IMAGE_PULL_POLICY, oldImagePullPolicy, imagePullPolicy));
	}
	...
	public void setReplicas(int newReplicas) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.ORCHESTRATOR_DEPLOYMENT_CONF__REPLICAS, oldReplicas, replicas));
	}
	...
	public void setCommand(String newCommand) {
		...
		command = newCommand;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.ORCHESTRATOR_DEPLOYMENT_CONF__COMMAND, oldCommand, command));
	}
	...
	public void setArgs(String newArgs) {
		...
		args = newArgs;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.ORCHESTRATOR_DEPLOYMENT_CONF__ARGS, oldArgs, args));
	}
	...
	public void setRestartPolicy(String newRestartPolicy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.ORCHESTRATOR_DEPLOYMENT_CONF__RESTART_POLICY, oldRestartPolicy, restartPolicy));
	}
	...
	public void setEnv(Properties newEnv) {
		...
		env = newEnv;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.ORCHESTRATOR_DEPLOYMENT_CONF__ENV, oldEnv, env));
	}
	...
	public EList<Volume> getVolumes() {
		if (volumes == null) {
			volumes = new EObjectContainmentEList<Volume>(Volume.class, this, Rai4Package.ORCHESTRATOR_DEPLOYMENT_CONF__VOLUMES);
		}
		return volumes;
	}
	...
	public EList<Port> getPorts() {
		if (ports == null) {
			ports = new EObjectContainmentEList<Port>(Port.class, this, Rai4Package.ORCHESTRATOR_DEPLOYMENT_CONF__PORTS);
		}
		return ports;
	}
	...
	public NotificationChain basicSetConstraints(DeploymentConstraints newConstraints, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Rai4Package.ORCHESTRATOR_DEPLOYMENT_CONF__CONSTRAINTS, oldConstraints, newConstraints);
	...
	public void setConstraints(DeploymentConstraints newConstraints) {
		if (newConstraints != constraints) {
			...
			if (constraints != null)
				msgs = ((InternalEObject)constraints).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Rai4Package.ORCHESTRATOR_DEPLOYMENT_CONF__CONSTRAINTS, null, msgs);
			if (newConstraints != null)
				msgs = ((InternalEObject)newConstraints).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Rai4Package.ORCHESTRATOR_DEPLOYMENT_CONF__CONSTRAINTS, null, msgs);
			msgs = basicSetConstraints(newConstraints, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.ORCHESTRATOR_DEPLOYMENT_CONF__CONSTRAINTS, newConstraints, newConstraints));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Rai4Package.ORCHESTRATOR_DEPLOYMENT_CONF__VOLUMES:
				return ((InternalEList<?>)getVolumes()).basicRemove(otherEnd, msgs);
			case Rai4Package.ORCHESTRATOR_DEPLOYMENT_CONF__PORTS:
				return ((InternalEList<?>)getPorts()).basicRemove(otherEnd, msgs);
			case Rai4Package.ORCHESTRATOR_DEPLOYMENT_CONF__CONSTRAINTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Rai4Package.ORCHESTRATOR_DEPLOYMENT_CONF__IMAGE:
				return getImage();
			case Rai4Package.ORCHESTRATOR_DEPLOYMENT_CONF__IMAGE_TAG:
				return getImageTag();
			case Rai4Package.ORCHESTRATOR_DEPLOYMENT_CONF__IMAGE_PULL_POLICY:
				return getImagePullPolicy();
			case Rai4Package.ORCHESTRATOR_DEPLOYMENT_CONF__REPLICAS:
				return getReplicas();
			case Rai4Package.ORCHESTRATOR_DEPLOYMENT_CONF__COMMAND:
				return getCommand();
			case Rai4Package.ORCHESTRATOR_DEPLOYMENT_CONF__ARGS:
				return getArgs();
			case Rai4Package.ORCHESTRATOR_DEPLOYMENT_CONF__RESTART_POLICY:
				return getRestartPolicy();
			case Rai4Package.ORCHESTRATOR_DEPLOYMENT_CONF__ENV:
				return getEnv();
			case Rai4Package.ORCHESTRATOR_DEPLOYMENT_CONF__VOLUMES:
				return getVolumes();
			case Rai4Package.ORCHESTRATOR_DEPLOYMENT_CONF__PORTS:
