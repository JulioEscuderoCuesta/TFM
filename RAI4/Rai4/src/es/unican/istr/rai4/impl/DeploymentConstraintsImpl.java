 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.rai4.impl.DeploymentConstraintsImpl#getLabels <em>Labels</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.DeploymentConstraintsImpl#getResources <em>Resources</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeploymentConstraintsImpl extends MinimalEObjectImpl.Container implements DeploymentConstraints {
	...
	protected EClass eStaticClass() {
		return Rai4Package.Literals.DEPLOYMENT_CONSTRAINTS;
	}
	...
	public void setLabels(Properties newLabels) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.DEPLOYMENT_CONSTRAINTS__LABELS, oldLabels, labels));
	}
	...
	public void setResources(Properties newResources) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.DEPLOYMENT_CONSTRAINTS__RESOURCES, oldResources, resources));
	}
