 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.rai4.impl.NomadDeploymentConfImpl#getRegion <em>Region</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.NomadDeploymentConfImpl#getDataCenter <em>Data Center</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.NomadDeploymentConfImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.NomadDeploymentConfImpl#getDriver <em>Driver</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NomadDeploymentConfImpl extends OrchestratorDeploymentConfImpl implements NomadDeploymentConf {
	...
	protected EClass eStaticClass() {
		return Rai4Package.Literals.NOMAD_DEPLOYMENT_CONF;
	}
	...
	public void setRegion(String newRegion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.NOMAD_DEPLOYMENT_CONF__REGION, oldRegion, region));
	}
	...
	public void setDataCenter(String newDataCenter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.NOMAD_DEPLOYMENT_CONF__DATA_CENTER, oldDataCenter, dataCenter));
	}
	...
	public void setPriority(int newPriority) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.NOMAD_DEPLOYMENT_CONF__PRIORITY, oldPriority, priority));
	}
	...
	public void setDriver(NomadDriver newDriver) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.NOMAD_DEPLOYMENT_CONF__DRIVER, oldDriver, driver));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Rai4Package.NOMAD_DEPLOYMENT_CONF__REGION:
				return getRegion();
			case Rai4Package.NOMAD_DEPLOYMENT_CONF__DATA_CENTER:
				return getDataCenter();
			case Rai4Package.NOMAD_DEPLOYMENT_CONF__PRIORITY:
				return getPriority();
			case Rai4Package.NOMAD_DEPLOYMENT_CONF__DRIVER:
				return getDriver();
		}
