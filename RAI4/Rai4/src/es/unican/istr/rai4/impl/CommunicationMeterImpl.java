 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.rai4.impl.CommunicationMeterImpl#getMetric <em>Metric</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CommunicationMeterImpl extends NodeHostedMeterImpl implements CommunicationMeter {
	...
	protected EClass eStaticClass() {
		return Rai4Package.Literals.COMMUNICATION_METER;
	}
		...
		if (metric != null && metric.eIsProxy()) {
			...
			if (metric != oldMetric) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Rai4Package.COMMUNICATION_METER__METRIC, oldMetric, metric));
			}
		}
		return metric;
	}
	...
	public void setMetric(NetworkUtilization newMetric) {
		...
		metric = newMetric;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.COMMUNICATION_METER__METRIC, oldMetric, metric));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Rai4Package.COMMUNICATION_METER__METRIC:
