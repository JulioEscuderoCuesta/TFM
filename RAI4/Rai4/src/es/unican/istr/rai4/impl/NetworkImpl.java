 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.rai4.impl.NetworkImpl#getBandwith <em>Bandwith</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NetworkImpl extends PlatformResourceImpl implements Network {
	...
	protected EClass eStaticClass() {
		return Rai4Package.Literals.NETWORK;
	}
	...
	public void setBandwith(double newBandwith) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.NETWORK__BANDWITH, oldBandwith, bandwith));
	}
