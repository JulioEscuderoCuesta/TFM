 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.rai4.impl.DataCenterImpl#getRacks <em>Racks</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataCenterImpl extends NamedElementImpl implements DataCenter {
	...
	protected EClass eStaticClass() {
		return Rai4Package.Literals.DATA_CENTER;
	}
	...
	public EList<Rack> getRacks() {
		if (racks == null) {
			racks = new EObjectContainmentEList<Rack>(Rack.class, this, Rai4Package.DATA_CENTER__RACKS);
		}
		return racks;
	}
