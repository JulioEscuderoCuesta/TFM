 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.rai4.impl.StreamDataRateImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StreamDataRateImpl extends MetricImpl implements StreamDataRate {
	...
	protected EClass eStaticClass() {
		return Rai4Package.Literals.STREAM_DATA_RATE;
	}
		...
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Rai4Package.STREAM_DATA_RATE__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(StreamData newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.STREAM_DATA_RATE__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Rai4Package.STREAM_DATA_RATE__TARGET:
