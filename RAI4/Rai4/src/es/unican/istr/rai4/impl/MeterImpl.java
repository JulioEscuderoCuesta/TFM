 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.rai4.impl.MeterImpl#getDeploymentConfig <em>Deployment Config</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.MeterImpl#getMonitoringServer <em>Monitoring Server</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class MeterImpl extends NamedElementImpl implements Meter {
	...
	protected EClass eStaticClass() {
		return Rai4Package.Literals.METER;
	}
	...
	public NotificationChain basicSetDeploymentConfig(DeploymentConfiguration newDeploymentConfig, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Rai4Package.METER__DEPLOYMENT_CONFIG, oldDeploymentConfig, newDeploymentConfig);
	...
	public void setDeploymentConfig(DeploymentConfiguration newDeploymentConfig) {
		if (newDeploymentConfig != deploymentConfig) {
			...
			if (deploymentConfig != null)
				msgs = ((InternalEObject)deploymentConfig).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Rai4Package.METER__DEPLOYMENT_CONFIG, null, msgs);
			if (newDeploymentConfig != null)
				msgs = ((InternalEObject)newDeploymentConfig).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Rai4Package.METER__DEPLOYMENT_CONFIG, null, msgs);
			msgs = basicSetDeploymentConfig(newDeploymentConfig, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.METER__DEPLOYMENT_CONFIG, newDeploymentConfig, newDeploymentConfig));
	}
	...
	public MonitoringService getMonitoringServer() {
		if (monitoringServer != null && monitoringServer.eIsProxy()) {
			...
			if (monitoringServer != oldMonitoringServer) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Rai4Package.METER__MONITORING_SERVER, oldMonitoringServer, monitoringServer));
			}
		}
	...
	public NotificationChain basicSetMonitoringServer(MonitoringService newMonitoringServer, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Rai4Package.METER__MONITORING_SERVER, oldMonitoringServer, newMonitoringServer);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMonitoringServer(MonitoringService newMonitoringServer) {
		if (newMonitoringServer != monitoringServer) {
			...
			if (monitoringServer != null)
				msgs = ((InternalEObject)monitoringServer).eInverseRemove(this, Rai4Package.MONITORING_SERVICE__MONITORIZED_METERS, MonitoringService.class, msgs);
			if (newMonitoringServer != null)
				msgs = ((InternalEObject)newMonitoringServer).eInverseAdd(this, Rai4Package.MONITORING_SERVICE__MONITORIZED_METERS, MonitoringService.class, msgs);
			msgs = basicSetMonitoringServer(newMonitoringServer, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.METER__MONITORING_SERVER, newMonitoringServer, newMonitoringServer));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Rai4Package.METER__MONITORING_SERVER:
				if (monitoringServer != null)
					msgs = ((InternalEObject)monitoringServer).eInverseRemove(this, Rai4Package.MONITORING_SERVICE__MONITORIZED_METERS, MonitoringService.class, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Rai4Package.METER__DEPLOYMENT_CONFIG:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == DeployableComponent.class) {
			switch (derivedFeatureID) {
				case Rai4Package.METER__DEPLOYMENT_CONFIG: return Rai4Package.DEPLOYABLE_COMPONENT__DEPLOYMENT_CONFIG;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == DeployableComponent.class) {
			switch (baseFeatureID) {
				case Rai4Package.DEPLOYABLE_COMPONENT__DEPLOYMENT_CONFIG: return Rai4Package.METER__DEPLOYMENT_CONFIG;
				default: return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == DeployableComponent.class) {
			switch (baseOperationID) {
				case Rai4Package.DEPLOYABLE_COMPONENT___CONFIGURE_DEPLOYMENT: return Rai4Package.METER___CONFIGURE_DEPLOYMENT;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Rai4Package.METER___CONFIGURE_DEPLOYMENT:
				try {
					configureDeployment();
					return null;
				}
