 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.rai4.impl.DeployableComponentImpl#getDeploymentConfig <em>Deployment Config</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class DeployableComponentImpl extends MinimalEObjectImpl.Container implements DeployableComponent {
	...
	protected EClass eStaticClass() {
		return Rai4Package.Literals.DEPLOYABLE_COMPONENT;
	}
	...
	public NotificationChain basicSetDeploymentConfig(DeploymentConfiguration newDeploymentConfig, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Rai4Package.DEPLOYABLE_COMPONENT__DEPLOYMENT_CONFIG, oldDeploymentConfig, newDeploymentConfig);
	...
	public void setDeploymentConfig(DeploymentConfiguration newDeploymentConfig) {
		if (newDeploymentConfig != deploymentConfig) {
			...
			if (deploymentConfig != null)
				msgs = ((InternalEObject)deploymentConfig).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Rai4Package.DEPLOYABLE_COMPONENT__DEPLOYMENT_CONFIG, null, msgs);
			if (newDeploymentConfig != null)
				msgs = ((InternalEObject)newDeploymentConfig).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Rai4Package.DEPLOYABLE_COMPONENT__DEPLOYMENT_CONFIG, null, msgs);
			msgs = basicSetDeploymentConfig(newDeploymentConfig, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.DEPLOYABLE_COMPONENT__DEPLOYMENT_CONFIG, newDeploymentConfig, newDeploymentConfig));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Rai4Package.DEPLOYABLE_COMPONENT__DEPLOYMENT_CONFIG:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Rai4Package.DEPLOYABLE_COMPONENT___CONFIGURE_DEPLOYMENT:
				try {
					configureDeployment();
					return null;
				}
