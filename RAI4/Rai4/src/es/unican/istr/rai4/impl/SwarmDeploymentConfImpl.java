 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.rai4.impl.SwarmDeploymentConfImpl#getNetwork <em>Network</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SwarmDeploymentConfImpl extends OrchestratorDeploymentConfImpl implements SwarmDeploymentConf {
	...
	protected EClass eStaticClass() {
		return Rai4Package.Literals.SWARM_DEPLOYMENT_CONF;
	}
	...
	public EList<String> getNetwork() {
		if (network == null) {
			network = new EDataTypeUniqueEList<String>(String.class, this, Rai4Package.SWARM_DEPLOYMENT_CONF__NETWORK);
		}
		return network;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Rai4Package.SWARM_DEPLOYMENT_CONF__NETWORK:
				return getNetwork();
		}
