 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.rai4.impl.StreamDataImpl#getRetention_ms <em>Retention ms</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.StreamDataImpl#getRetention_bytes <em>Retention bytes</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.StreamDataImpl#isCleanupPolicy <em>Cleanup Policy</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.StreamDataImpl#getNumPartitions <em>Num Partitions</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.StreamDataImpl#getNumReplication <em>Num Replication</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.StreamDataImpl#getOwnedMeters <em>Owned Meters</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.StreamDataImpl#getAssignedPartition <em>Assigned Partition</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.StreamDataImpl#getMessageSize <em>Message Size</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.StreamDataImpl#getSchemaFile <em>Schema File</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class StreamDataImpl extends DeployableComponentImpl implements StreamData {
	...
	protected EClass eStaticClass() {
		return Rai4Package.Literals.STREAM_DATA;
	}
	...
	public void setRetention_ms(long newRetention_ms) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.STREAM_DATA__RETENTION_MS, oldRetention_ms, retention_ms));
	}
	...
	public void setRetention_bytes(int newRetention_bytes) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.STREAM_DATA__RETENTION_BYTES, oldRetention_bytes, retention_bytes));
	}
	...
	public void setCleanupPolicy(boolean newCleanupPolicy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.STREAM_DATA__CLEANUP_POLICY, oldCleanupPolicy, cleanupPolicy));
	}
	...
	public void setNumPartitions(int newNumPartitions) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.STREAM_DATA__NUM_PARTITIONS, oldNumPartitions, numPartitions));
	}
	...
	public void setNumReplication(int newNumReplication) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.STREAM_DATA__NUM_REPLICATION, oldNumReplication, numReplication));
	}
	...
	public EList<StreamRateMeter> getOwnedMeters() {
		if (ownedMeters == null) {
			ownedMeters = new EObjectContainmentWithInverseEList<StreamRateMeter>(StreamRateMeter.class, this, Rai4Package.STREAM_DATA__OWNED_METERS, Rai4Package.STREAM_RATE_METER__OWNER);
		}
		return ownedMeters;
	}
	...
	public EList<StreamDataPartition> getAssignedPartition() {
		if (assignedPartition == null) {
			assignedPartition = new EObjectContainmentEList<StreamDataPartition>(StreamDataPartition.class, this, Rai4Package.STREAM_DATA__ASSIGNED_PARTITION);
		}
	...
	public void setMessageSize(int newMessageSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.STREAM_DATA__MESSAGE_SIZE, oldMessageSize, messageSize));
	}
	...
	public void setSchemaFile(String newSchemaFile) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.STREAM_DATA__SCHEMA_FILE, oldSchemaFile, schemaFile));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Rai4Package.STREAM_DATA__OWNED_METERS:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case Rai4Package.STREAM_DATA__ASSIGNED_PARTITION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Rai4Package.STREAM_DATA__RETENTION_MS:
				return getRetention_ms();
			case Rai4Package.STREAM_DATA__RETENTION_BYTES:
				return getRetention_bytes();
			case Rai4Package.STREAM_DATA__CLEANUP_POLICY:
				return isCleanupPolicy();
			case Rai4Package.STREAM_DATA__NUM_PARTITIONS:
				return getNumPartitions();
			case Rai4Package.STREAM_DATA__NUM_REPLICATION:
				return getNumReplication();
			case Rai4Package.STREAM_DATA__OWNED_METERS:
				return getOwnedMeters();
			case Rai4Package.STREAM_DATA__ASSIGNED_PARTITION:
				return getAssignedPartition();
			case Rai4Package.STREAM_DATA__MESSAGE_SIZE:
				return getMessageSize();
			case Rai4Package.STREAM_DATA__SCHEMA_FILE:
