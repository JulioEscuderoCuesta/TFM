 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.rai4.impl.KafkaServiceImpl#getCommId <em>Comm Id</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.KafkaServiceImpl#getClientPort <em>Client Port</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.KafkaServiceImpl#getZookeeperConnect <em>Zookeeper Connect</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.KafkaServiceImpl#getZookeeperConnectionTimeout <em>Zookeeper Connection Timeout</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.KafkaServiceImpl#getListeners <em>Listeners</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.KafkaServiceImpl#getAdvertisedListeners <em>Advertised Listeners</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.KafkaServiceImpl#isAutoCreateTopicEnable <em>Auto Create Topic Enable</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.KafkaServiceImpl#isDeleteTopicEnable <em>Delete Topic Enable</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.KafkaServiceImpl#getNumPartitions <em>Num Partitions</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.KafkaServiceImpl#getNumRecoveryThreadsPerDataDir <em>Num Recovery Threads Per Data Dir</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.KafkaServiceImpl#getLogFlushIntervalMessages <em>Log Flush Interval Messages</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.KafkaServiceImpl#getLogFlushInterval <em>Log Flush Interval</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.KafkaServiceImpl#getNumNetworkThreads <em>Num Network Threads</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.KafkaServiceImpl#getNumIOThreads <em>Num IO Threads</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.KafkaServiceImpl#getSocketSendBufferBytes <em>Socket Send Buffer Bytes</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.KafkaServiceImpl#getSocketReceiveBufferBytes <em>Socket Receive Buffer Bytes</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.KafkaServiceImpl#getSocketRequestMaxBytes <em>Socket Request Max Bytes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class KafkaServiceImpl extends CommunicationServiceImpl implements KafkaService {
	...
	protected EClass eStaticClass() {
		return Rai4Package.Literals.KAFKA_SERVICE;
	}
	...
	public void setCommId(int newCommId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.KAFKA_SERVICE__COMM_ID, oldCommId, commId));
	}
	...
	public void setClientPort(String newClientPort) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.KAFKA_SERVICE__CLIENT_PORT, oldClientPort, clientPort));
	}
	...
	public ZookeeperService getZookeeperConnect() {
		if (zookeeperConnect != null && zookeeperConnect.eIsProxy()) {
			...
			if (zookeeperConnect != oldZookeeperConnect) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Rai4Package.KAFKA_SERVICE__ZOOKEEPER_CONNECT, oldZookeeperConnect, zookeeperConnect));
			}
		}
	...
	public void setZookeeperConnect(ZookeeperService newZookeeperConnect) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.KAFKA_SERVICE__ZOOKEEPER_CONNECT, oldZookeeperConnect, zookeeperConnect));
	}
	...
	public void setZookeeperConnectionTimeout(int newZookeeperConnectionTimeout) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.KAFKA_SERVICE__ZOOKEEPER_CONNECTION_TIMEOUT, oldZookeeperConnectionTimeout, zookeeperConnectionTimeout));
	}
	...
	public void setListeners(String newListeners) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.KAFKA_SERVICE__LISTENERS, oldListeners, listeners));
	}
	...
	public void setAdvertisedListeners(String newAdvertisedListeners) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.KAFKA_SERVICE__ADVERTISED_LISTENERS, oldAdvertisedListeners, advertisedListeners));
	}
	...
	public void setAutoCreateTopicEnable(boolean newAutoCreateTopicEnable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.KAFKA_SERVICE__AUTO_CREATE_TOPIC_ENABLE, oldAutoCreateTopicEnable, autoCreateTopicEnable));
	}
	...
	public void setDeleteTopicEnable(boolean newDeleteTopicEnable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.KAFKA_SERVICE__DELETE_TOPIC_ENABLE, oldDeleteTopicEnable, deleteTopicEnable));
	}
	...
	public void setNumPartitions(int newNumPartitions) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.KAFKA_SERVICE__NUM_PARTITIONS, oldNumPartitions, numPartitions));
	}
	...
	public void setNumRecoveryThreadsPerDataDir(int newNumRecoveryThreadsPerDataDir) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.KAFKA_SERVICE__NUM_RECOVERY_THREADS_PER_DATA_DIR, oldNumRecoveryThreadsPerDataDir, numRecoveryThreadsPerDataDir));
	}
	...
	public void setLogFlushIntervalMessages(int newLogFlushIntervalMessages) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.KAFKA_SERVICE__LOG_FLUSH_INTERVAL_MESSAGES, oldLogFlushIntervalMessages, logFlushIntervalMessages));
	}
	...
	public void setLogFlushInterval(int newLogFlushInterval) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.KAFKA_SERVICE__LOG_FLUSH_INTERVAL, oldLogFlushInterval, logFlushInterval));
	}
	...
	public void setNumNetworkThreads(int newNumNetworkThreads) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.KAFKA_SERVICE__NUM_NETWORK_THREADS, oldNumNetworkThreads, numNetworkThreads));
	}
	...
	public void setNumIOThreads(int newNumIOThreads) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.KAFKA_SERVICE__NUM_IO_THREADS, oldNumIOThreads, numIOThreads));
	}
	...
	public void setSocketSendBufferBytes(int newSocketSendBufferBytes) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.KAFKA_SERVICE__SOCKET_SEND_BUFFER_BYTES, oldSocketSendBufferBytes, socketSendBufferBytes));
	}
	...
	public void setSocketReceiveBufferBytes(int newSocketReceiveBufferBytes) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.KAFKA_SERVICE__SOCKET_RECEIVE_BUFFER_BYTES, oldSocketReceiveBufferBytes, socketReceiveBufferBytes));
	}
	...
	public void setSocketRequestMaxBytes(int newSocketRequestMaxBytes) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.KAFKA_SERVICE__SOCKET_REQUEST_MAX_BYTES, oldSocketRequestMaxBytes, socketRequestMaxBytes));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Rai4Package.KAFKA_SERVICE__COMM_ID:
				return getCommId();
			case Rai4Package.KAFKA_SERVICE__CLIENT_PORT:
				return getClientPort();
			case Rai4Package.KAFKA_SERVICE__ZOOKEEPER_CONNECT:
				if (resolve) return getZookeeperConnect();
				return basicGetZookeeperConnect();
			case Rai4Package.KAFKA_SERVICE__ZOOKEEPER_CONNECTION_TIMEOUT:
				return getZookeeperConnectionTimeout();
			case Rai4Package.KAFKA_SERVICE__LISTENERS:
				return getListeners();
			case Rai4Package.KAFKA_SERVICE__ADVERTISED_LISTENERS:
				return getAdvertisedListeners();
			case Rai4Package.KAFKA_SERVICE__AUTO_CREATE_TOPIC_ENABLE:
				return isAutoCreateTopicEnable();
			case Rai4Package.KAFKA_SERVICE__DELETE_TOPIC_ENABLE:
				return isDeleteTopicEnable();
			case Rai4Package.KAFKA_SERVICE__NUM_PARTITIONS:
				return getNumPartitions();
			case Rai4Package.KAFKA_SERVICE__NUM_RECOVERY_THREADS_PER_DATA_DIR:
				return getNumRecoveryThreadsPerDataDir();
			case Rai4Package.KAFKA_SERVICE__LOG_FLUSH_INTERVAL_MESSAGES:
				return getLogFlushIntervalMessages();
			case Rai4Package.KAFKA_SERVICE__LOG_FLUSH_INTERVAL:
				return getLogFlushInterval();
			case Rai4Package.KAFKA_SERVICE__NUM_NETWORK_THREADS:
				return getNumNetworkThreads();
			case Rai4Package.KAFKA_SERVICE__NUM_IO_THREADS:
				return getNumIOThreads();
			case Rai4Package.KAFKA_SERVICE__SOCKET_SEND_BUFFER_BYTES:
				return getSocketSendBufferBytes();
			case Rai4Package.KAFKA_SERVICE__SOCKET_RECEIVE_BUFFER_BYTES:
				return getSocketReceiveBufferBytes();
			case Rai4Package.KAFKA_SERVICE__SOCKET_REQUEST_MAX_BYTES:
