 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.rai4.impl.ArtifactDescriptorImpl#getLocalPath <em>Local Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArtifactDescriptorImpl extends FileDescriptorImpl implements ArtifactDescriptor {
	...
	protected EClass eStaticClass() {
		return Rai4Package.Literals.ARTIFACT_DESCRIPTOR;
	}
	...
	public void setLocalPath(String newLocalPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.ARTIFACT_DESCRIPTOR__LOCAL_PATH, oldLocalPath, localPath));
	}
