 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.rai4.impl.TaskImpl#getOwner <em>Owner</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.TaskImpl#getImplementingClassName <em>Implementing Class Name</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.TaskImpl#getReturnedStreamData <em>Returned Stream Data</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.TaskImpl#getTriggerStreamData <em>Trigger Stream Data</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.TaskImpl#getInputStreamData <em>Input Stream Data</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TaskImpl extends NamedElementImpl implements Task {
	...
	protected EClass eStaticClass() {
		return Rai4Package.Literals.TASK;
	}
	...
	public Workflow getOwner() {
		if (eContainerFeatureID() != Rai4Package.TASK__OWNER) return null;
	...
	public NotificationChain basicSetOwner(Workflow newOwner, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newOwner, Rai4Package.TASK__OWNER, msgs);
		return msgs;
	}
	...
	public void setOwner(Workflow newOwner) {
		if (newOwner != eInternalContainer() || (eContainerFeatureID() != Rai4Package.TASK__OWNER && newOwner != null)) {
			...
			if (newOwner != null)
				msgs = ((InternalEObject)newOwner).eInverseAdd(this, Rai4Package.WORKFLOW__OWNED_TASKS, Workflow.class, msgs);
			msgs = basicSetOwner(newOwner, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.TASK__OWNER, newOwner, newOwner));
	}
	...
	public void setImplementingClassName(String newImplementingClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.TASK__IMPLEMENTING_CLASS_NAME, oldImplementingClassName, implementingClassName));
	}
	...
	public StreamData getReturnedStreamData() {
		if (returnedStreamData != null && returnedStreamData.eIsProxy()) {
			...
			if (returnedStreamData != oldReturnedStreamData) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Rai4Package.TASK__RETURNED_STREAM_DATA, oldReturnedStreamData, returnedStreamData));
			}
		}
	...
	public void setReturnedStreamData(StreamData newReturnedStreamData) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.TASK__RETURNED_STREAM_DATA, oldReturnedStreamData, returnedStreamData));
	}
	...
	public StreamData getTriggerStreamData() {
		if (triggerStreamData != null && triggerStreamData.eIsProxy()) {
			...
			if (triggerStreamData != oldTriggerStreamData) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Rai4Package.TASK__TRIGGER_STREAM_DATA, oldTriggerStreamData, triggerStreamData));
			}
		}
	...
	public void setTriggerStreamData(StreamData newTriggerStreamData) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.TASK__TRIGGER_STREAM_DATA, oldTriggerStreamData, triggerStreamData));
	}
	...
	public EList<StreamData> getInputStreamData() {
		if (inputStreamData == null) {
			inputStreamData = new EObjectResolvingEList<StreamData>(StreamData.class, this, Rai4Package.TASK__INPUT_STREAM_DATA);
		}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case Rai4Package.TASK__OWNER:
				return eInternalContainer().eInverseRemove(this, Rai4Package.WORKFLOW__OWNED_TASKS, Workflow.class, msgs);
		}
