 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.rai4.impl.WorkloadStreamDataImpl#getDeploymentConfig <em>Deployment Config</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.WorkloadStreamDataImpl#getRetention_ms <em>Retention ms</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.WorkloadStreamDataImpl#getRetention_bytes <em>Retention bytes</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.WorkloadStreamDataImpl#isCleanupPolicy <em>Cleanup Policy</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.WorkloadStreamDataImpl#getNumPartitions <em>Num Partitions</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.WorkloadStreamDataImpl#getNumReplication <em>Num Replication</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.WorkloadStreamDataImpl#getOwnedMeters <em>Owned Meters</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.WorkloadStreamDataImpl#getAssignedPartition <em>Assigned Partition</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.WorkloadStreamDataImpl#getMessageSize <em>Message Size</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.WorkloadStreamDataImpl#getSchemaFile <em>Schema File</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.WorkloadStreamDataImpl#getHolder <em>Holder</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkloadStreamDataImpl extends SystemElementImpl implements WorkloadStreamData {
	...
	protected EClass eStaticClass() {
		return Rai4Package.Literals.WORKLOAD_STREAM_DATA;
	}
	...
	public NotificationChain basicSetDeploymentConfig(DeploymentConfiguration newDeploymentConfig, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Rai4Package.WORKLOAD_STREAM_DATA__DEPLOYMENT_CONFIG, oldDeploymentConfig, newDeploymentConfig);
	...
	public void setDeploymentConfig(DeploymentConfiguration newDeploymentConfig) {
		if (newDeploymentConfig != deploymentConfig) {
			...
			if (deploymentConfig != null)
				msgs = ((InternalEObject)deploymentConfig).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Rai4Package.WORKLOAD_STREAM_DATA__DEPLOYMENT_CONFIG, null, msgs);
			if (newDeploymentConfig != null)
				msgs = ((InternalEObject)newDeploymentConfig).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Rai4Package.WORKLOAD_STREAM_DATA__DEPLOYMENT_CONFIG, null, msgs);
			msgs = basicSetDeploymentConfig(newDeploymentConfig, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.WORKLOAD_STREAM_DATA__DEPLOYMENT_CONFIG, newDeploymentConfig, newDeploymentConfig));
	}
	...
	public void setRetention_ms(long newRetention_ms) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.WORKLOAD_STREAM_DATA__RETENTION_MS, oldRetention_ms, retention_ms));
	}
	...
	public void setRetention_bytes(int newRetention_bytes) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.WORKLOAD_STREAM_DATA__RETENTION_BYTES, oldRetention_bytes, retention_bytes));
	}
	...
	public void setCleanupPolicy(boolean newCleanupPolicy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.WORKLOAD_STREAM_DATA__CLEANUP_POLICY, oldCleanupPolicy, cleanupPolicy));
	}
	...
	public void setNumPartitions(int newNumPartitions) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.WORKLOAD_STREAM_DATA__NUM_PARTITIONS, oldNumPartitions, numPartitions));
	}
	...
	public void setNumReplication(int newNumReplication) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.WORKLOAD_STREAM_DATA__NUM_REPLICATION, oldNumReplication, numReplication));
	}
	...
	public EList<StreamRateMeter> getOwnedMeters() {
		if (ownedMeters == null) {
			ownedMeters = new EObjectContainmentWithInverseEList<StreamRateMeter>(StreamRateMeter.class, this, Rai4Package.WORKLOAD_STREAM_DATA__OWNED_METERS, Rai4Package.STREAM_RATE_METER__OWNER);
		}
		return ownedMeters;
	}
	...
	public EList<StreamDataPartition> getAssignedPartition() {
		if (assignedPartition == null) {
			assignedPartition = new EObjectContainmentEList<StreamDataPartition>(StreamDataPartition.class, this, Rai4Package.WORKLOAD_STREAM_DATA__ASSIGNED_PARTITION);
		}
	...
	public void setMessageSize(int newMessageSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.WORKLOAD_STREAM_DATA__MESSAGE_SIZE, oldMessageSize, messageSize));
	}
	...
	public void setSchemaFile(String newSchemaFile) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.WORKLOAD_STREAM_DATA__SCHEMA_FILE, oldSchemaFile, schemaFile));
	}
	...
	public CommunicationService getHolder() {
		if (holder != null && holder.eIsProxy()) {
			...
			if (holder != oldHolder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Rai4Package.WORKLOAD_STREAM_DATA__HOLDER, oldHolder, holder));
			}
		}
		return holder;
	}
	...
	public void setHolder(CommunicationService newHolder) {
		...
		holder = newHolder;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.WORKLOAD_STREAM_DATA__HOLDER, oldHolder, holder));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Rai4Package.WORKLOAD_STREAM_DATA__OWNED_METERS:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Rai4Package.WORKLOAD_STREAM_DATA__DEPLOYMENT_CONFIG:
				return basicSetDeploymentConfig(null, msgs);
			case Rai4Package.WORKLOAD_STREAM_DATA__OWNED_METERS:
				return ((InternalEList<?>)getOwnedMeters()).basicRemove(otherEnd, msgs);
			case Rai4Package.WORKLOAD_STREAM_DATA__ASSIGNED_PARTITION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Rai4Package.WORKLOAD_STREAM_DATA__RETENTION_MS:
				return getRetention_ms();
			case Rai4Package.WORKLOAD_STREAM_DATA__RETENTION_BYTES:
				return getRetention_bytes();
			case Rai4Package.WORKLOAD_STREAM_DATA__CLEANUP_POLICY:
				return isCleanupPolicy();
			case Rai4Package.WORKLOAD_STREAM_DATA__NUM_PARTITIONS:
				return getNumPartitions();
			case Rai4Package.WORKLOAD_STREAM_DATA__NUM_REPLICATION:
				return getNumReplication();
			case Rai4Package.WORKLOAD_STREAM_DATA__OWNED_METERS:
				return getOwnedMeters();
			case Rai4Package.WORKLOAD_STREAM_DATA__ASSIGNED_PARTITION:
				return getAssignedPartition();
			case Rai4Package.WORKLOAD_STREAM_DATA__MESSAGE_SIZE:
				return getMessageSize();
			case Rai4Package.WORKLOAD_STREAM_DATA__SCHEMA_FILE:
				return getSchemaFile();
			case Rai4Package.WORKLOAD_STREAM_DATA__HOLDER:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == DeployableComponent.class) {
			switch (derivedFeatureID) {
				case Rai4Package.WORKLOAD_STREAM_DATA__DEPLOYMENT_CONFIG: return Rai4Package.DEPLOYABLE_COMPONENT__DEPLOYMENT_CONFIG;
				default: return -1;
			}
		}
		if (baseClass == StreamData.class) {
			switch (derivedFeatureID) {
				case Rai4Package.WORKLOAD_STREAM_DATA__RETENTION_MS: return Rai4Package.STREAM_DATA__RETENTION_MS;
				case Rai4Package.WORKLOAD_STREAM_DATA__RETENTION_BYTES: return Rai4Package.STREAM_DATA__RETENTION_BYTES;
				case Rai4Package.WORKLOAD_STREAM_DATA__CLEANUP_POLICY: return Rai4Package.STREAM_DATA__CLEANUP_POLICY;
				case Rai4Package.WORKLOAD_STREAM_DATA__NUM_PARTITIONS: return Rai4Package.STREAM_DATA__NUM_PARTITIONS;
				case Rai4Package.WORKLOAD_STREAM_DATA__NUM_REPLICATION: return Rai4Package.STREAM_DATA__NUM_REPLICATION;
				case Rai4Package.WORKLOAD_STREAM_DATA__OWNED_METERS: return Rai4Package.STREAM_DATA__OWNED_METERS;
				case Rai4Package.WORKLOAD_STREAM_DATA__ASSIGNED_PARTITION: return Rai4Package.STREAM_DATA__ASSIGNED_PARTITION;
				case Rai4Package.WORKLOAD_STREAM_DATA__MESSAGE_SIZE: return Rai4Package.STREAM_DATA__MESSAGE_SIZE;
				case Rai4Package.WORKLOAD_STREAM_DATA__SCHEMA_FILE: return Rai4Package.STREAM_DATA__SCHEMA_FILE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == DeployableComponent.class) {
			switch (baseFeatureID) {
				case Rai4Package.DEPLOYABLE_COMPONENT__DEPLOYMENT_CONFIG: return Rai4Package.WORKLOAD_STREAM_DATA__DEPLOYMENT_CONFIG;
				default: return -1;
			}
		}
		if (baseClass == StreamData.class) {
			switch (baseFeatureID) {
				case Rai4Package.STREAM_DATA__RETENTION_MS: return Rai4Package.WORKLOAD_STREAM_DATA__RETENTION_MS;
				case Rai4Package.STREAM_DATA__RETENTION_BYTES: return Rai4Package.WORKLOAD_STREAM_DATA__RETENTION_BYTES;
				case Rai4Package.STREAM_DATA__CLEANUP_POLICY: return Rai4Package.WORKLOAD_STREAM_DATA__CLEANUP_POLICY;
				case Rai4Package.STREAM_DATA__NUM_PARTITIONS: return Rai4Package.WORKLOAD_STREAM_DATA__NUM_PARTITIONS;
				case Rai4Package.STREAM_DATA__NUM_REPLICATION: return Rai4Package.WORKLOAD_STREAM_DATA__NUM_REPLICATION;
				case Rai4Package.STREAM_DATA__OWNED_METERS: return Rai4Package.WORKLOAD_STREAM_DATA__OWNED_METERS;
				case Rai4Package.STREAM_DATA__ASSIGNED_PARTITION: return Rai4Package.WORKLOAD_STREAM_DATA__ASSIGNED_PARTITION;
				case Rai4Package.STREAM_DATA__MESSAGE_SIZE: return Rai4Package.WORKLOAD_STREAM_DATA__MESSAGE_SIZE;
				case Rai4Package.STREAM_DATA__SCHEMA_FILE: return Rai4Package.WORKLOAD_STREAM_DATA__SCHEMA_FILE;
				default: return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == DeployableComponent.class) {
			switch (baseOperationID) {
				case Rai4Package.DEPLOYABLE_COMPONENT___CONFIGURE_DEPLOYMENT: return Rai4Package.WORKLOAD_STREAM_DATA___CONFIGURE_DEPLOYMENT;
				default: return -1;
			}
		}
		if (baseClass == StreamData.class) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Rai4Package.WORKLOAD_STREAM_DATA___CONFIGURE_DEPLOYMENT:
				try {
					configureDeployment();
					return null;
				}
