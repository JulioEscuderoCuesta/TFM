 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.rai4.impl.KubernetesClusterImpl#getApiVersion <em>Api Version</em>}</li>
 *   <li>{@link es.unican.istr.rai4.impl.KubernetesClusterImpl#getKubeConfigPath <em>Kube Config Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public class KubernetesClusterImpl extends OrchestrationClusterImpl implements KubernetesCluster {
	...
	protected EClass eStaticClass() {
		return Rai4Package.Literals.KUBERNETES_CLUSTER;
	}
	...
	public void setApiVersion(String newApiVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.KUBERNETES_CLUSTER__API_VERSION, oldApiVersion, apiVersion));
	}
	...
	public void setKubeConfigPath(String newKubeConfigPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Rai4Package.KUBERNETES_CLUSTER__KUBE_CONFIG_PATH, oldKubeConfigPath, kubeConfigPath));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Rai4Package.KUBERNETES_CLUSTER__API_VERSION:
				return getApiVersion();
			case Rai4Package.KUBERNETES_CLUSTER__KUBE_CONFIG_PATH:
