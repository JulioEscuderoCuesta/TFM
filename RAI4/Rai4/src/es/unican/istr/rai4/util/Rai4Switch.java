 ...
 * @generated
 */
public class Rai4Switch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Rai4Package.COMPUTATIONAL_SYSTEM: {
			...
			case Rai4Package.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Rai4Package.SYSTEM_ELEMENT: {
			...
			case Rai4Package.PLATFORM_RESOURCE: {
			...
			case Rai4Package.PROCESSING_NODE: {
			...
			case Rai4Package.PHYSICAL_PROCESSING_NODE: {
			...
			case Rai4Package.VIRTUAL_PROCESSING_NODE: {
			...
			case Rai4Package.AWS_VIRTUAL_PROCESSING_NODE: {
			...
			case Rai4Package.PROCESSING_RESOURCE_CLUSTER: {
			...
			case Rai4Package.PROCESSING_NODE_CLUSTER: {
			...
			case Rai4Package.ORCHESTRATION_CLUSTER: {
			...
			case Rai4Package.KUBERNETES_CLUSTER: {
			...
			case Rai4Package.SWARM_CLUSTER: {
			...
			case Rai4Package.NOMAD_CLUSTER: {
			...
			case Rai4Package.PLATFORM_SERVICE: {
			...
			case Rai4Package.SERIALIZATION_SERVICE: {
			...
			case Rai4Package.DISTRIBUTION_SERVICE: {
			...
			case Rai4Package.COMMUNICATION_SERVICE: {
			...
			case Rai4Package.SCHEDULING_SERVICE: {
			...
			case Rai4Package.SECURITY_SERVICE: {
			...
			case Rai4Package.PERSISTENCE_SERVICE: {
			...
			case Rai4Package.MONITORING_SERVICE: {
			...
			case Rai4Package.ZOOKEEPER_SERVICE: {
			...
			case Rai4Package.KAFKA_SERVICE: {
			...
			case Rai4Package.NODE_SCHEDULER: {
			...
			case Rai4Package.SPARK_SERVICE: {
			...
			case Rai4Package.STORM_SERVICE: {
			...
			case Rai4Package.STORM_SUPERVISOR: {
			...
			case Rai4Package.NEO4_JSERVICE: {
			...
			case Rai4Package.MEM_SQL_SERVICE: {
			...
			case Rai4Package.CASSANDRA_SERVICE: {
			...
			case Rai4Package.PROMETHEUS_SERVICE: {
			...
			case Rai4Package.STREAM_DATA_PARTITION: {
			...
			case Rai4Package.WORKFLOW_STREAM_DATA: {
			...
			case Rai4Package.FLOW_STREAM_DATA: {
			...
			case Rai4Package.KAFKA_FLOW_STREAM_DATA: {
			...
			case Rai4Package.DERIVED_STREAM_DATA: {
			...
			case Rai4Package.WORKLOAD_STREAM_DATA: {
			...
			case Rai4Package.KAFKA_WORKLOAD_STREAM_DATA: {
			...
			case Rai4Package.SCHEDULABLE_SET: {
			...
			case Rai4Package.TASK_EXECUTOR: {
			...
			case Rai4Package.PROCESSING_NODE_UTILIZATION: {
			...
			case Rai4Package.PROCESSING_NODE_MEMORY: {
			...
			case Rai4Package.NETWORK_UTILIZATION: {
			...
			case Rai4Package.WORKFLOW_LATENCY: {
			...
			case Rai4Package.TASK_PROCESSING_AMOUNT: {
			...
			case Rai4Package.STREAM_DATA_RATE: {
			...
			case Rai4Package.PROMETHEUS_METER: {
			...
			case Rai4Package.NODE_HOSTED_METER: {
			...
			case Rai4Package.NODE_RESOURCE_METER: {
			...
			case Rai4Package.COMMUNICATION_METER: {
			...
			case Rai4Package.STREAM_RATE_METER: {
			...
			case Rai4Package.WORKFLOW_LATENCY_METER: {
			...
			case Rai4Package.TASK_PROCESSING_AMOUNT_METER: {
			...
			case Rai4Package.DEPLOYABLE_COMPONENT: {
			...
			case Rai4Package.DEPLOYMENT_CONFIGURATION: {
			...
			case Rai4Package.PLATFORM_SERVICE_DEPLOYMENT_CONF: {
			...
			case Rai4Package.ORCHESTRATOR_DEPLOYMENT_CONF: {
			...
			case Rai4Package.NODE_DEPLOYMENT_CONF: {
			...
			case Rai4Package.KUBERNETES_DEPLOYMENT_CONF: {
			...
			case Rai4Package.SWARM_DEPLOYMENT_CONF: {
			...
			case Rai4Package.NOMAD_DEPLOYMENT_CONF: {
			...
			case Rai4Package.VOLUME: {
				Volume volume = (Volume)theEObject;
				T result = caseVolume(volume);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Rai4Package.PORT: {
				Port port = (Port)theEObject;
				T result = casePort(port);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Rai4Package.DEPLOYMENT_CONSTRAINTS: {
			...
			case Rai4Package.DEPLOYMENT_EXCEPTION: {
			...
			case Rai4Package.LAUNCH_EXCEPTION: {
			...
			case Rai4Package.ARTIFACT_DESCRIPTOR: {
