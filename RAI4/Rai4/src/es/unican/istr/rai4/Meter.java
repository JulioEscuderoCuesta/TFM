 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.rai4.Meter#getMonitoringServer <em>Monitoring Server</em>}</li>
 * </ul>
 *
 * @see es.unican.istr.rai4.Rai4Package#getMeter()
 * @model abstract="true"
 * @generated
 */
public interface Meter extends NamedElement, DeployableComponent {
	 ...
	 * It is bidirectional and its opposite is '{@link es.unican.istr.rai4.MonitoringService#getMonitorizedMeters <em>Monitorized Meters</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Monitoring Server</em>' reference.
	 * @see #setMonitoringServer(MonitoringService)
	 * @see es.unican.istr.rai4.Rai4Package#getMeter_MonitoringServer()
	...
	/**
	 * Sets the value of the '{@link es.unican.istr.rai4.Meter#getMonitoringServer <em>Monitoring Server</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
