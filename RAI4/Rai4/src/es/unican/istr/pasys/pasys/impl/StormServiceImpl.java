 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.StormServiceImpl#getZookeeperConnect <em>Zookeeper Connect</em>}</li>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.StormServiceImpl#getLocalDir <em>Local Dir</em>}</li>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.StormServiceImpl#getNimbus <em>Nimbus</em>}</li>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.StormServiceImpl#getSupervisor <em>Supervisor</em>}</li>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.StormServiceImpl#getUi <em>Ui</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StormServiceImpl extends SchedulingServiceImpl implements StormService {
	...
	private String generateConfigFileContent() throws YamlException, ConfigurationException {
		...
		HashMap<String, Object> map = (HashMap) object;   // PAT Antes pon�a "HashMap map" solo
