 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.SparkServiceImpl#getLoad <em>Load</em>}</li>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.SparkServiceImpl#getDriverCores <em>Driver Cores</em>}</li>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.SparkServiceImpl#getDriverMaxResultSize <em>Driver Max Result Size</em>}</li>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.SparkServiceImpl#getDriverMemory <em>Driver Memory</em>}</li>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.SparkServiceImpl#getLocalDir <em>Local Dir</em>}</li>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.SparkServiceImpl#getMaster <em>Master</em>}</li>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.SparkServiceImpl#getWindowSize <em>Window Size</em>}</li>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.SparkServiceImpl#getExecutorMemory <em>Executor Memory</em>}</li>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.SparkServiceImpl#getExtraListener <em>Extra Listener</em>}</li>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.SparkServiceImpl#isLogConf <em>Log Conf</em>}</li>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.SparkServiceImpl#getSubmitDeployMode <em>Submit Deploy Mode</em>}</li>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.SparkServiceImpl#getLogCallerContext <em>Log Caller Context</em>}</li>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.SparkServiceImpl#isDriverSuperviser <em>Driver Superviser</em>}</li>
 * </ul>
 *
 * @generated
 */
