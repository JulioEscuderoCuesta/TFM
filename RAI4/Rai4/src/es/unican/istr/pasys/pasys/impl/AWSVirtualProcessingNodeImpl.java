 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.AWSVirtualProcessingNodeImpl#getVpc <em>Vpc</em>}</li>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.AWSVirtualProcessingNodeImpl#getSubNet <em>Sub Net</em>}</li>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.AWSVirtualProcessingNodeImpl#getKeyPair <em>Key Pair</em>}</li>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.AWSVirtualProcessingNodeImpl#getSecurityGroup <em>Security Group</em>}</li>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.AWSVirtualProcessingNodeImpl#getAMI <em>AMI</em>}</li>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.AWSVirtualProcessingNodeImpl#getInstanceType <em>Instance Type</em>}</li>
 * </ul>
 *
 * @generated
 */
