 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.WorkloadStreamDataImpl#getDeploymentConfig <em>Deployment Config</em>}</li>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.WorkloadStreamDataImpl#getRetention_ms <em>Retention ms</em>}</li>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.WorkloadStreamDataImpl#getRetention_bytes <em>Retention bytes</em>}</li>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.WorkloadStreamDataImpl#isCleanupPolicy <em>Cleanup Policy</em>}</li>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.WorkloadStreamDataImpl#getNumPartitions <em>Num Partitions</em>}</li>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.WorkloadStreamDataImpl#getNumReplication <em>Num Replication</em>}</li>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.WorkloadStreamDataImpl#getOwnedMeters <em>Owned Meters</em>}</li>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.WorkloadStreamDataImpl#getAssignedPartition <em>Assigned Partition</em>}</li>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.WorkloadStreamDataImpl#getMessageSize <em>Message Size</em>}</li>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.WorkloadStreamDataImpl#getSchemaFile <em>Schema File</em>}</li>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.WorkloadStreamDataImpl#getHolder <em>Holder</em>}</li>
 * </ul>
 *
 * @generated
 */
