 ...
 * </p>
 * <ul>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.WorkflowLatencyMeterImpl#getOwner <em>Owner</em>}</li>
 *   <li>{@link es.unican.istr.pasys.pasys.impl.WorkflowLatencyMeterImpl#getMetric <em>Metric</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkflowLatencyMeterImpl extends PrometheusMeterImpl implements WorkflowLatencyMeter {
	...
	public void setMetric(WorkflowLatency newMetric) {
		...
		metric = newMetric;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PasysPackage.WORKFLOW_LATENCY_METER__METRIC, oldMetric, metric));
	}
