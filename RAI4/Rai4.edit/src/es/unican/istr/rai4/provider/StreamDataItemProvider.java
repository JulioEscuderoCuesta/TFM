...
/**
 * This is the item provider adapter for a {@link es.unican.istr.rai4.StreamData} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StreamDataItemProvider extends DeployableComponentItemProvider {
	/**
	 ...
	 * @generated
	 */
	public StreamDataItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Rai4Package.Literals.STREAM_DATA__RETENTION_MS,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Rai4Package.Literals.STREAM_DATA__RETENTION_BYTES,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Rai4Package.Literals.STREAM_DATA__CLEANUP_POLICY,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Rai4Package.Literals.STREAM_DATA__NUM_PARTITIONS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Rai4Package.Literals.STREAM_DATA__NUM_REPLICATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Rai4Package.Literals.STREAM_DATA__MESSAGE_SIZE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Rai4Package.Literals.STREAM_DATA__SCHEMA_FILE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Rai4Package.Literals.STREAM_DATA__OWNED_METERS);
			childrenFeatures.add(Rai4Package.Literals.STREAM_DATA__ASSIGNED_PARTITION);
		}
	...
	public String getText(Object object) {
		StreamData streamData = (StreamData)object;
		return getString("_UI_StreamData_type") + " " + streamData.getRetention_ms();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StreamData.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Rai4Package.Literals.STREAM_DATA__OWNED_METERS,
				 Rai4Factory.eINSTANCE.createStreamRateMeter()));

		newChildDescriptors.add
			(createChildParameter
				(Rai4Package.Literals.STREAM_DATA__ASSIGNED_PARTITION,
				 Rai4Factory.eINSTANCE.createStreamDataPartition()));
	}
