...
/**
 * This is the item provider adapter for a {@link es.unican.istr.rai4.OrchestratorDeploymentConf} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OrchestratorDeploymentConfItemProvider extends PlatformServiceDeploymentConfItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Rai4Package.Literals.ORCHESTRATOR_DEPLOYMENT_CONF__IMAGE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Rai4Package.Literals.ORCHESTRATOR_DEPLOYMENT_CONF__IMAGE_TAG,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Rai4Package.Literals.ORCHESTRATOR_DEPLOYMENT_CONF__IMAGE_PULL_POLICY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Rai4Package.Literals.ORCHESTRATOR_DEPLOYMENT_CONF__REPLICAS,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Rai4Package.Literals.ORCHESTRATOR_DEPLOYMENT_CONF__COMMAND,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Rai4Package.Literals.ORCHESTRATOR_DEPLOYMENT_CONF__ARGS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Rai4Package.Literals.ORCHESTRATOR_DEPLOYMENT_CONF__RESTART_POLICY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Rai4Package.Literals.ORCHESTRATOR_DEPLOYMENT_CONF__ENV,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Rai4Package.Literals.ORCHESTRATOR_DEPLOYMENT_CONF__VOLUMES);
			childrenFeatures.add(Rai4Package.Literals.ORCHESTRATOR_DEPLOYMENT_CONF__PORTS);
			childrenFeatures.add(Rai4Package.Literals.ORCHESTRATOR_DEPLOYMENT_CONF__CONSTRAINTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Rai4Package.Literals.ORCHESTRATOR_DEPLOYMENT_CONF__VOLUMES,
				 Rai4Factory.eINSTANCE.createVolume()));

		newChildDescriptors.add
			(createChildParameter
				(Rai4Package.Literals.ORCHESTRATOR_DEPLOYMENT_CONF__PORTS,
				 Rai4Factory.eINSTANCE.createPort()));

		newChildDescriptors.add
			(createChildParameter
				(Rai4Package.Literals.ORCHESTRATOR_DEPLOYMENT_CONF__CONSTRAINTS,
				 Rai4Factory.eINSTANCE.createDeploymentConstraints()));
	}
