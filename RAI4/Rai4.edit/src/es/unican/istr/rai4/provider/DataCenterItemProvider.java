...
/**
 * This is the item provider adapter for a {@link es.unican.istr.rai4.DataCenter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataCenterItemProvider extends NamedElementItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Rai4Package.Literals.DATA_CENTER__RACKS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DataCenter.class)) {
			case Rai4Package.DATA_CENTER__RACKS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Rai4Package.Literals.DATA_CENTER__RACKS,
				 Rai4Factory.eINSTANCE.createRack()));
	}
