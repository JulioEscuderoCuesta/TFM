...
/**
 * This is the item provider adapter for a {@link es.unican.istr.rai4.Network} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NetworkItemProvider extends PlatformResourceItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Network_bandwith_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Network_bandwith_feature", "_UI_Network_type"),
				 Rai4Package.Literals.NETWORK__BANDWITH,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Network.class)) {
			case Rai4Package.NETWORK__BANDWITH:
