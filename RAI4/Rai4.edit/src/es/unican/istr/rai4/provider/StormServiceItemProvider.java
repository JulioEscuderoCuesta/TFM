...
/**
 * This is the item provider adapter for a {@link es.unican.istr.rai4.StormService} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StormServiceItemProvider extends SchedulingServiceItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Rai4Package.Literals.STORM_SERVICE__ZOOKEEPER_CONNECT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Rai4Package.Literals.STORM_SERVICE__LOCAL_DIR,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Rai4Package.Literals.STORM_SERVICE__NIMBUS);
			childrenFeatures.add(Rai4Package.Literals.STORM_SERVICE__SUPERVISOR);
			childrenFeatures.add(Rai4Package.Literals.STORM_SERVICE__UI);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Rai4Package.Literals.STORM_SERVICE__NIMBUS,
				 Rai4Factory.eINSTANCE.createStormNimbus()));

		newChildDescriptors.add
			(createChildParameter
				(Rai4Package.Literals.STORM_SERVICE__SUPERVISOR,
				 Rai4Factory.eINSTANCE.createStormSupervisor()));

		newChildDescriptors.add
			(createChildParameter
				(Rai4Package.Literals.STORM_SERVICE__UI,
				 Rai4Factory.eINSTANCE.createStormUI()));
	}
