...
/**
 * This is the item provider adapter for a {@link es.unican.istr.rai4.Port} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PortItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Port_target_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Port_target_feature", "_UI_Port_type"),
				 Rai4Package.Literals.PORT__TARGET,
				 true,
				 false,
				 false,
	...
	protected void addPublishedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Port_published_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Port_published_feature", "_UI_Port_type"),
				 Rai4Package.Literals.PORT__PUBLISHED,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Port)object).getTarget();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Port.class)) {
			case Rai4Package.PORT__TARGET:
			case Rai4Package.PORT__PUBLISHED:
