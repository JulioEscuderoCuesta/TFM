...
/**
 * This is the item provider adapter for a {@link es.unican.istr.rai4.PlatformService} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PlatformServiceItemProvider extends PlatformResourceItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Rai4Package.Literals.PLATFORM_SERVICE__HOST,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PlatformService.class)) {
			case Rai4Package.PLATFORM_SERVICE__DEPLOYMENT_CONFIG:
