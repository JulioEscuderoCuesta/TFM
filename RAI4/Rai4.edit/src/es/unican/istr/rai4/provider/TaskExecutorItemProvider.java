...
/**
 * This is the item provider adapter for a {@link es.unican.istr.rai4.TaskExecutor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskExecutorItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Rai4Package.Literals.TASK_EXECUTOR__EXECUTED_TASKS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Rai4Package.Literals.TASK_EXECUTOR__OWNED_METERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Rai4Package.Literals.TASK_EXECUTOR__OWNED_METERS,
				 Rai4Factory.eINSTANCE.createTaskProcessingAmountMeter()));
	}
